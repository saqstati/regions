...
<body>
    ...
    $item[0][] = "ქალაქების და დაბების რაოდენობა (ერთეული)";
    $item[0][] = "სოფლების რაოდენობა (ერთეული)";
    $item[0][] = "მოსახლეობის რიცხოვნობა (ათასი)";
    $item[0][] = "ცოცხლად დაბადებულთა რიცხოვნობა (კაცი)";
    $item[0][] = "შობადობის ზოგადი კოეფიციენტი (დაბადებულთა რიცხოვნობა მოსახლეობის 1000 კაცზე)";
    $item[0][] = "გარდაცვლილთა რიცხოვნობა (კაცი)";
    $item[0][] = "მოკვდაობის ზოგადი კოეფიციენტი (გარდაცვლილთა რიცხოვნობა მოსახლეობის 1000 კაცზე)";
    ...
    $item[0][] = "აქტიური ეკონომიკური სუბიექტების რაოდენობა (ერთეული)";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $item[$i][] = $row["Name"];
        $item[$i][] = $row["Area"];
        $item[$i][] = $row["NumberOfCT"];
        $item[$i][] = $row["Villages"];
        $item[$i][] = $row["Population"];
        $item[$i][] = $row["LiveBirths"];
        $item[$i][] = $row["GeneralBirthRate"];
        $item[$i][] = $row["Dead"];
        $item[$i][] = $row["GeneralMortalityRate"];
        $item[$i][] = $row["Employees"];
        $item[$i][] = $row["AVGSalary"];
        $item[$i][] = $row["RegEcSub"];
        $item[$i][] = $row["ActEcSub"];
    }
    ?>
