        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-md-6 d-flex flex-column justify-content-center align-items-center" style="height: 100%;">
                ...
                <div class="w-100 text-center p-4 rounded" style="height: 100%;">
                    <svg id="svg4380" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 1000" version="1.1">
                        <g id="layer8" style="transform: scale(8.1);-webkit-transform-origin-x: 1600px;-webkit-transform-origin-y: 911px;">
