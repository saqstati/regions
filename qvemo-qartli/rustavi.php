        ...
        <table class="machveneblebi-left">
            ...
            <tbody>
                ...
                <tr class="informacia15">
                    ...
                    <td>
                        <span class="float-right"><a href="<?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? 'http://localhost/regions/municipal/ENG/Share%20of%20Agriculture%20Land%20Area/Kvemo%20Kartli/Rustavi.xlsx' : 'http://localhost/regions/municipal/soflis%20meurneoba/ეკო_აქტ/ქვემო%20ქართლი/რუსთავის.xlsx'; ?>"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr>
