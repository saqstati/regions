...
<div class="col-12 col-md-3">
    <table class="table">
        ...
        if (strpos($current_page, 'bolnisi') !== false) {
            $municipal_info = [
                'en_name' => 'Bolnisi',
                'en_full' => 'Bolnisi Municipality',
                'en_short' => 'Bolnisi', // used in some paths
                'ka_name' => 'ბოლნისი',
                'ka_full' => 'ბოლნისის მუნიციპალიტეტი',
                'ka_short' => 'ბოლნისი' // used when "ქ." prefix causes issues
            ];
        } elseif (strpos($current_page, 'dmanisi') !== false || strpos($current_page, 'dmanisi') !== false) {
            $municipal_info = [
                'en_name' => 'Dmanisi',
                'en_full' => 'Dmanisi Municipality',
                'en_short' => 'Dmanisi',
                'ka_name' => 'დმანისი',
                'ka_full' => 'დმანისის მუნიციპალიტეტი',
                'ka_short' => 'დმანისი'
            ];
        } elseif (strpos($current_page, 'gardabani') !== false || strpos($current_page, 'gardabani') !== false) {
            $municipal_info = [
                'en_name' => 'Gardabani',
                'en_full' => 'Gardabani Municipality',
                'en_short' => 'Gardabani',
                'ka_name' => 'გარდაბანი',
                'ka_full' => 'გარდაბნის მუნიციპალიტეტი',
                'ka_short' => 'გარდაბანი'
            ];
        } elseif (strpos($current_page, 'marneuli') !== false) {
            $municipal_info = [
                'en_name' => 'Marneuli',
                'en_full' => 'Marneuli Municipality',
                'en_short' => 'Marneuli',
                'ka_name' => 'მარნეული',
                'ka_full' => 'მარნეულის მუნიციპალიტეტი',
                'ka_short' => 'მარნეული'
            ];
        } elseif (strpos($current_page, 'rustavi') !== false || strpos($current_page, 'rustavi') !== false) {
            $municipal_info = [
                'en_name' => 'C. Rustavi',
                'en_full' => 'C. Rustavi Municipality',
                'en_short' => 'C. Rustavi',
                'ka_name' => 'ქ. რუსთავი',
                'ka_full' => 'ქ. რუსთავის მუნიციპალიტეტი',
                'ka_short' => 'რუსთავი'
            ];
        } elseif (strpos($current_page, 'tetriwyaro') !== false || strpos($current_page, 'tetritskaro') !== false) {
            $municipal_info = [
                'en_name' => 'Tetritskaro',
                'en_full' => 'Tetritskaro Municipality',
                'en_short' => 'Tetritskaro',
                'ka_name' => 'თეთრიწყარო',
                'ka_full' => 'თეთრიწყაროს მუნიციპალიტეტი',
                'ka_short' => 'თეთრიწყარო'
            ];
        } elseif (strpos($current_page, 'walka') !== false) {
            $municipal_info = [
                'en_name' => 'Tsalka',
                'en_full' => 'Tsalka Municipality',
                'en_short' => 'Tsalka',
                'ka_name' => 'წალკა',
                'ka_full' => 'წალკის მუნიციპალიტეტი',
                'ka_short' => 'წალკა'
            ];
        } else {
            // Fallback
         ...
         * ======================= */
                ...
                'main_info_admin' => [
                    'en' => "ENG/Main%20Information/Administrative%20structure/Kvemo%20Kartli/{$enShort}",
                    'ka' => "ძირითადი%20ინფორმაცია/ადმინისტრაციული%20მოწყობა/ქვემო%20ქართლი/{$ka}"
                ],
         ...
         * ======================= */
                ...
                'birth_stillbirths_by_sex' => [
                    'en' => "ENG/Demography/Number%20of%20stillbirths%20by%20sex/Kvemo%20Kartli/{$en}",
                    'ka' => "დემოგრაფია/მკვდართშობილები%20სქესის%20მიხედვით/ქვემო%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'trading_markets_legal' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20organizational%20legal%20forms%20in%20Georgia/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ორგანიზაციულ-სამართლებლივი%20ფორმების%20მიხედვით/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_ownership' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20ownership%20type%20in%20Georgia/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20საკუთრების%20ფორმის%20მიხედვით/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_type' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20type%20in%20Georgia/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ტიპების%20მიხედვით/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_days' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20on%20days%20of%20trade/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ვაჭრობის%20დღეთა%20მიხედვით/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'trading_employed' => [
                    'en' => "ENG/Trading/Average%20annual%20number%20of%20employed%20persons/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20დირექციებში%20დასაქმებულთა%20რაოდენობა/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'trading_sellers' => [
                    'en' => "ENG/Trading/Number%20of%20market-place%20and%20sellers%20on%20the%20markets%20and%20fairs/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრებში%20და%20ბაზრობებში%20სავაჭრო%20ადგილების%20და%20მოვაჭრეთა%20რაოდენობა/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'trading_financial' => [
         ...
         * ======================= */
                'transport_roads' => [
                    'en' => "ENG/TransportAndStorage/Length%20of%20transport%20ways/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "ტრანსპორტი%20და%20დასაწყობება/საერთო%20სარგებლობის%20საავტომობილო%20გზების%20სიგრძე/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'tourism_domestic' => [
                    'en' => "ENG/Tourism/Kvemo%20Kartli/{$en}",
                    'ka' => "ტურიზმი/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'education_preschool' => [
                    'en' => "ENG/Education/Preschool%20and%20Education%20Institutions/Kvemo%20Kartli/{$en}",
                    'ka' => "განათლება/სკოლამდელი%20აღზრდისა%20და%20განათლების%20დაწესებულებები/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'education_general' => [
                ...
                'education_status' => [
                    ...
                    'ka' => "განათლება/სტატუსი/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'education_directors' => [
         ...
         * ======================= */
                'business_register_entities' => [
                    'en' => "ENG/Business%20Register/Registered%20entities%20per%201000%20persons/Kvemo%20Kartli/{$en}",
                    'ka' => "ბიზნეს%20რეგისტრი/რეგისტრირებული%20სუბიექტები/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                ...
                'business_register_active' => [
                    ...
                    'ka' => "ბიზნეს%20რეგისტრი/ეკონომიკურად%20აქტიური%20ბიზნეს%20სუბიექტების%20რაოდენობა/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'business_register_public' => [
                    'en' => "ENG/Business%20Register/Number%20of%20public%20institutions/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/საჯარო%20დაწესებულებების%20რაოდენობა/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'economic_activity_registered' => [
                    'en' => "ENG/byKindOfEconomicActivity/Number%20of%20registered%20entities%20by%20kind%20of%20economic%20activity/Kvemo%20Kartli/{$en}",
                    'ka' => "ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/ქვემო%20ქართლი/{$kaSafe}"
                ],
                'economic_activity_active' => [
                    'en' => "ENG/byKindOfEconomicActivity/Number%20of%20active%20entities%20by%20kind%20of%20economic%20activity/Kvemo%20Kartli/{$en}",
                    'ka' => "ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/ქვემო%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'ownership_registered' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20registered%20entities%20by%20ownership%20type/Kvemo%20Kartli/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20საკუთრების%20ფორმების%20მიხედვით/ქვემო%20ქართლი/{$kaSafe}"
                ],
                'ownership_active_size' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20active%20entities%20by%20ownership%20type%20and%20size/Kvemo%20Kartli/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20საკუთრების%20ფორმებისა%20და%20ზომების%20მიხედვით/ქვემო%20ქართლი/{$kaSafe}"
                ],
                'ownership_newly' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20entities%20newly%20registered%20in%20Georgia%20by%20ownership%20type/Kvemo%20Kartli/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/ახლადრეგისტრირებულ%20სუბიექტთა%20რაოდენობა/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'organizational_registered' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20registered%20entities%20by%20organizational-legal%20form/Kvemo%20Kartli/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/ქვემო%20ქართლი/{$kaSafe}"
                ],
                'organizational_active' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20active%20entities%20by%20organizational-legal%20form/Kvemo%20Kartli/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვ/ქვემო%20ქართლი/{$kaSafe}"
                ],
                'organizational_newly' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20entities%20newly%20registered%20in%20Georgia%20by%20organizational-legal%20form/Kvemo%20Kartli/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/ახლადრეგისტრირებულ%20სუბიექტთა%20რაოდენობა/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'agriculture_land' => [
                    'en' => "ENG/Share%20of%20Agriculture%20Land%20Area/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "soflis%20meurneoba/ეკო_აქტ/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'hotels_accommodation' => [
                    'en' => "ENG/Hotels/Accommodation/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/სასტუმრო%20ობიექტები/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'hotels_visitors_residents' => [
                    'en' => "ENG/Hotels/Visitors%20Residents/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ვიზიტორები%20რეზიდენტები/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'hotels_visitors_nonresidents' => [
                    'en' => "ENG/Hotels/Visitors%20non%20residents/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ვიზიტორები%20არარეზიდენტები/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'hotels_nights_residents' => [
                    'en' => "ENG/Hotels/Nights%20spent%20Residents/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ღამეები%20რეზიდენტები/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'hotels_number_area' => [
                    'en' => "ENG/Hotels/Number%20of%20hotels%20and%20hotel-type%20establishments%20and%20their%20total%20area/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სასტუმროების%20რაოდენობა%20და%20ფართობი/ქვემო%20ქართლი/{$kaSafe}"
                ],
                'hotels_rooms' => [
                    'en' => "ENG/Hotels/Number%20of%20Rooms%20in%20Hotels%20and%20Hotel-type%20enterprises/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმროები/ნომრების%20რაოდენობა%20სასტუმროებსა%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში/ქვემო%20ქართლი/{$kaSafe}"
                ],
                'hotels_guests' => [
                    'en' => "ENG/Hotels/Guests/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სტუმრები/ქვემო%20ქართლი/{$kaSafe}"
                ],
                'hotels_employees' => [
                    'en' => "ENG/Hotels/Number%20of%20Employees%20in%20Hotels%20and%20Hotel-type%20enterprises/Kvemo%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სასტუმროების%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში%20დასაქმებულთა%20რაოდენობა%20სქესის%20მიხედვით/ქვემო%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                ...
                'social_disability' => [
                    ...
                    'ka' => "სოციალური%20სტატისტიკა/დევნილი%20შშმ%20პირები/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'social_registered' => [
                    'en' => "ENG/Social%20Statistic/Disabilities%20Registered/Kvemo%20Kartli/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/რეგისტრირებული%20შშმ%20პირები/ქვემო%20ქართლი/{$municipal_info['ka_full']}"
                ],
