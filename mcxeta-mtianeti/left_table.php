...
<div class="col-12 col-md-3">
    <table class="table">
        ...
        if (strpos($current_page, 'dusheti') !== false) {
            $municipal_info = [
                'en_name' => 'Dusheti',
                'en_full' => 'Dusheti Municipality',
                'en_short' => 'Dusheti', // used in some paths
                'ka_name' => 'დუშეთი',
                'ka_full' => 'დუშეთის მუნიციპალიტეტი',
                'ka_short' => 'დუშეთი' // used when "ქ." prefix causes issues
            ];
        } elseif (strpos($current_page, 'mcxeta') !== false || strpos($current_page, 'mtskheta') !== false) {
            $municipal_info = [
                'en_name' => 'Mtskheta',
                'en_full' => 'Mtskheta Municipality',
                'en_short' => 'Mtskheta',
                'ka_name' => 'მცხეთა',
                'ka_full' => 'მცხეთის მუნიციპალიტეტი',
                'ka_short' => 'მცხეთა'
            ];
        } elseif (strpos($current_page, 'tianeti') !== false || strpos($current_page, 'tianeti') !== false) {
            $municipal_info = [
                'en_name' => 'Tianeti',
                'en_full' => 'Tianeti Municipality',
                'en_short' => 'Tianeti',
                'ka_name' => 'თიანეთი',
                'ka_full' => 'თიანეთის მუნიციპალიტეტი',
                'ka_short' => 'თიანეთი'
            ];
        } elseif (strpos($current_page, 'yazbegi') !== false || strpos($current_page, 'kazbegi') !== false) {
            $municipal_info = [
                'en_name' => 'Kazbegi',
                'en_full' => 'Kazbegi Municipality',
                'en_short' => 'Kazbegi',
                'ka_name' => 'ყაზბეგი',
                'ka_full' => 'ყაზბეგის მუნიციპალიტეტი',
                'ka_short' => 'ყაზბეგი'
            ];
        } else {
            // Fallback
         ...
         * ======================= */
                ...
                'main_info_admin' => [
                    'en' => "ENG/Main%20Information/Administrative%20structure/Mtskheta-Mtianeti/{$enShort}",
                    'ka' => "ძირითადი%20ინფორმაცია/ადმინისტრაციული%20მოწყობა/მცხეთა-მთიანეთი/{$ka}"
                ],
         ...
         * ======================= */
                'pop_urban_rural' => [
                    'en' => "ENG/Population%20census%20pre/urban-rural%20settlements/Mtskheta-Mtianeti/{$en}",
                    'ka' => "მოსახლეობის%20აღწერა%20წინასწარი/მოსახლეობა%20საქალაქო-სასოფლო/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'pop_by_sex' => [
                    'en' => "ENG/Population%20census%20pre/number%20of%20population%20by%20sex/Mtskheta-Mtianeti/{$en}",
                    'ka' => "მოსახლეობის%20აღწერა%20წინასწარი/მოსახლეობა%20სქესის%20მიხედვით/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'employment_employed' => [
                    'en' => "ENG/Employment%20and%20Wages/Employed%20persons/Mtskheta-Mtianeti/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/დასაქმებულები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'employment_employees' => [
                    'en' => "ENG/Employment%20and%20Wages/Employees/Mtskheta-Mtianeti/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/დაქირავებულები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'employment_salary' => [
                    'en' => "ENG/Employment%20and%20Wages/Average%20monthly%20remuneration/Mtskheta-Mtianeti/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/ხელფასი/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'business_investments_fixed' => [
                    'en' => "ENG/Business%20Sector/Investments%20in%20fixed%20assets/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ინვესტიციები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                ...
                'birth_stillbirths_by_sex' => [
                    'en' => "ENG/Demography/Number%20of%20stillbirths%20by%20sex/Mtskheta-Mtianeti/{$en}",
                    'ka' => "დემოგრაფია/მკვდართშობილები%20სქესის%20მიხედვით/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'business_turnover' => [
                    'en' => "ENG/Business%20Sector/turnover/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ბრუნვა/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'business_production' => [
                    'en' => "ENG/Business%20Sector/Production%20Value/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/პროდუქციის%20გამოშვება/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'business_personnel_costs' => [
                    'en' => "ENG/Business%20Sector/Pesronal%20Costs/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/შრომითი%20დანახარჯები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'business_purchases' => [
                    'en' => "ENG/Business%20Sector/Purchase%20of%20good%20and%20services/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/საქონლისა%20და%20მომსახურების%20ყიდვები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'business_purchases_resale' => [
                    'en' => "ENG/Business%20Sector/Purchase%20of%20good%20and%20services%20for%20resale/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/გადასაყიდად%20განკუთვნილი%20საქონლისა%20და%20მომსახურების%20ყიდვები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'business_value_added' => [
                    'en' => "ENG/Business%20Sector/Value%20added/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/დამატებული%20ღირებულება/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'business_intermediate' => [
                    'en' => "ENG/Business%20Sector/Intermediate%20consumption/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/შუალედური%20მოხმარება/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'business_investment' => [
                    'en' => "ENG/Business%20Sector/Investment%20in%20fixed%20assets/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ინვესტიცია%20ძირითად%20კაპიტალში/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'budget_main' => [
                    'en' => "ENG/Budget/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ბიუჯეტი/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'construction_permissions' => [
                    'en' => "ENG/Construction/Permissions%20granted/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "მშენებლობა/მშენებლობაზე%20გაცემული%20ნებართვები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'construction_completed' => [
                    'en' => "ENG/Construction/Completed%20Construction/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "მშენებლობა/დასრულებული%20მშენებლობა/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'trading_markets_legal' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20organizational%20legal%20forms%20in%20Georgia/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ორგანიზაციულ-სამართლებლივი%20ფორმების%20მიხედვით/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_ownership' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20ownership%20type%20in%20Georgia/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20საკუთრების%20ფორმის%20მიხედვით/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_type' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20type%20in%20Georgia/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ტიპების%20მიხედვით/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_days' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20on%20days%20of%20trade/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ვაჭრობის%20დღეთა%20მიხედვით/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'trading_employed' => [
                    'en' => "ENG/Trading/Average%20annual%20number%20of%20employed%20persons/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20დირექციებში%20დასაქმებულთა%20რაოდენობა/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'trading_sellers' => [
                    'en' => "ENG/Trading/Number%20of%20market-place%20and%20sellers%20on%20the%20markets%20and%20fairs/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრებში%20და%20ბაზრობებში%20სავაჭრო%20ადგილების%20და%20მოვაჭრეთა%20რაოდენობა/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'trading_financial' => [
                    'en' => "ENG/Trading/Financial%20indices%20of%20markets%20and%20fairs/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20საფინანსო%20მაჩვენებლები/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'transport_roads' => [
                    'en' => "ENG/TransportAndStorage/Length%20of%20transport%20ways/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ტრანსპორტი%20და%20დასაწყობება/საერთო%20სარგებლობის%20საავტომობილო%20გზების%20სიგრძე/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'tourism_domestic' => [
                    'en' => "ENG/Tourism/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ტურიზმი/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'healthcare_indicators' => [
                    'en' => "ENG/Healthcare/Indicators/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ჯანდაცვა/მაჩვენებლები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'healthcare_emergent' => [
                    'en' => "ENG/Healthcare/Emergent/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ჯანდაცვა/სასწრაფო/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'healthcare_abortions' => [
                    'en' => "ENG/Healthcare/Abortions/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ჯანდაცვა/აბორტები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'healthcare_anemia' => [
                    'en' => "ENG/Healthcare/Anemia/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ჯანდაცვა/ანემია/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'healthcare_diabetes' => [
                    'en' => "ENG/Healthcare/Diabetes/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ჯანდაცვა/დიაბეტი/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'healthcare_cancer' => [
                    'en' => "ENG/Healthcare/Cancer/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ჯანდაცვა/კიბო/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'healthcare_circulatory' => [
                    'en' => "ENG/Healthcare/Circulatory/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ჯანდაცვა/სისხლის%20მიმოქცევა/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'healthcare_respiratory' => [
                    'en' => "ENG/Healthcare/Respiratory/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ჯანდაცვა/სუნთქვა/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'healthcare_syphilis' => [
                    'en' => "ENG/Healthcare/Syphilis/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ჯანდაცვა/ათაშანგი/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'healthcare_aids' => [
                    'en' => "ENG/Healthcare/AIDS/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ჯანდაცვა/შიდსი/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'healthcare_tuberculosis' => [
                    'en' => "ENG/Healthcare/Tuberculosis/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ჯანდაცვა/ტუბერკულიოზი/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'healthcare_hepatitis' => [
                    'en' => "ENG/Healthcare/Hepatitis/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ჯანდაცვა/ჰეპატიტი/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                ...
                'social_subsistence' => [
                    'en' => "ENG/Social%20Statistic/Subsistence%20Allowance/Mtskheta-Mtianeti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/საარსებო/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'social_receiving' => [
                    'en' => "ENG/Social%20Statistic/Receiving/Mtskheta-Mtianeti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/მიმღები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'social_beneficiaries' => [
                    'en' => "ENG/Social%20Statistic/Beneficiaries/Mtskheta-Mtianeti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/ბენეფიციართა/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'education_preschool' => [
                    'en' => "ENG/Education/Preschool%20and%20Education%20Institutions/Mtskheta-Mtianeti/{$en}",
                    'ka' => "განათლება/სკოლამდელი%20აღზრდისა%20და%20განათლების%20დაწესებულებები/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'education_general' => [
                    'en' => "ENG/Education/General%20Educational%20Institution/Mtskheta-Mtianeti/{$en}",
                    'ka' => "განათლება/ზოგადსაგანმანათლებლო%20დაწესებულებები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'education_status' => [
                    'en' => "ENG/Education/Status/Mtskheta-Mtianeti/{$municipal_info['en_full']}",
                    'ka' => "განათლება/სტატუსი/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'education_directors' => [
                    'en' => "ENG/Education/Directors/Mtskheta-Mtianeti/{$municipal_info['en_full']}",
                    'ka' => "განათლება/დირექტორები/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'education_vocational' => [
                    'en' => "ENG/Education/Vocational%20and%20Higher%20educational%20institutions/Adjara/{$en}",
                    'ka' => "განათლება/პროფესიული%20და%20უმაღლესი%20საგანმანათლებლო%20დაწესებულებები/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'culture' => [
                    'en' => "ENG/Culture/Mtskheta-Mtianeti/{$en}",
                    'ka' => "კულტურა/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                ...
                'trading_financial_indices' => [
                    'en' => "ENG/Trading/Financial%20indices%20of%20markets%20and%20fairs/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20საფინანსო%20მაჩვენებლები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'business_register_entities' => [
                    'en' => "ENG/Business%20Register/Registered%20entities%20per%201000%20persons/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ბიზნეს%20რეგისტრი/რეგისტრირებული%20სუბიექტები/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'business_register_newly' => [
                    'en' => "ENG/Business%20Register/Number%20of%20newly%20registered%20business%20entities%20in%20Georgia/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/ახლად%20რეგისტრირებული%20ბიზნეს%20სუბიექტები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'business_register_active' => [
                    'en' => "ENG/Business%20Register/Number%20of%20active%20business%20entities%20registered%20in%20Georgia/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/ეკონომიკურად%20აქტიური%20ბიზნეს%20სუბიექტების%20რაოდენობა/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'business_register_public' => [
                    'en' => "ENG/Business%20Register/Number%20of%20public%20institutions/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/საჯარო%20დაწესებულებების%20რაოდენობა/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'economic_activity_registered' => [
                    'en' => "ENG/byKindOfEconomicActivity/Number%20of%20registered%20entities%20by%20kind%20of%20economic%20activity/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'economic_activity_active' => [
                    'en' => "ENG/byKindOfEconomicActivity/Number%20of%20active%20entities%20by%20kind%20of%20economic%20activity/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'ownership_registered' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20registered%20entities%20by%20ownership%20type/Mtskheta-Mtianeti/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20საკუთრების%20ფორმების%20მიხედვით/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'ownership_active_size' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20active%20entities%20by%20ownership%20type%20and%20size/Mtskheta-Mtianeti/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20საკუთრების%20ფორმებისა%20და%20ზომების%20მიხედვით/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'ownership_newly' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20entities%20newly%20registered%20in%20Georgia%20by%20ownership%20type/Mtskheta-Mtianeti/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/ახლადრეგისტრირებულ%20სუბიექტთა%20რაოდენობა/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'organizational_registered' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20registered%20entities%20by%20organizational-legal%20form/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'organizational_active' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20active%20entities%20by%20organizational-legal%20form/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვ/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'organizational_newly' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20entities%20newly%20registered%20in%20Georgia%20by%20organizational-legal%20form/Mtskheta-Mtianeti/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/ახლადრეგისტრირებულ%20სუბიექტთა%20რაოდენობა/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'agriculture_land' => [
                    'en' => "ENG/Share%20of%20Agriculture%20Land%20Area/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "soflis%20meurneoba/ეკო_აქტ/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'hotels_accommodation' => [
                    'en' => "ENG/Hotels/Accommodation/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/სასტუმრო%20ობიექტები/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'hotels_visitors_residents' => [
                    'en' => "ENG/Hotels/Visitors%20Residents/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ვიზიტორები%20რეზიდენტები/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'hotels_visitors_nonresidents' => [
                    'en' => "ENG/Hotels/Visitors%20non%20residents/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ვიზიტორები%20არარეზიდენტები/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'hotels_nights_residents' => [
                    'en' => "ENG/Hotels/Nights%20spent%20Residents/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ღამეები%20რეზიდენტები/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'hotels_number_area' => [
                    'en' => "ENG/Hotels/Number%20of%20hotels%20and%20hotel-type%20establishments%20and%20their%20total%20area/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სასტუმროების%20რაოდენობა%20და%20ფართობი/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'hotels_rooms' => [
                    'en' => "ENG/Hotels/Number%20of%20Rooms%20in%20Hotels%20and%20Hotel-type%20enterprises/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/ნომრების%20რაოდენობა%20სასტუმროებსა%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'hotels_guests' => [
                    'en' => "ENG/Hotels/Guests/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სტუმრები/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
                'hotels_employees' => [
                    'en' => "ENG/Hotels/Number%20of%20Employees%20in%20Hotels%20and%20Hotel-type%20enterprises/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სასტუმროების%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში%20დასაქმებულთა%20რაოდენობა%20სქესის%20მიხედვით/მცხეთა-მთიანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'social_indicators' => [
                    'en' => "ENG/Social%20Statistic/Indicators/Mtskheta-Mtianeti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/მაჭვენებლები/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'social_disability' => [
                    'en' => "ENG/Social%20Statistic/Disability%20Persons/Mtskheta-Mtianeti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/დევნილი%20შშმ%20პირები/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'social_registered' => [
                    'en' => "ENG/Social%20Statistic/Disabilities%20Registered/Mtskheta-Mtianeti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/რეგისტრირებული%20შშმ%20პირები/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'self_governance' => [
                    'en' => "ENG/Government/Self-Governance/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ხელისუფლება/თვითმმართველობა/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
                'voters' => [
                    'en' => "ENG/Government/Voters/Mtskheta-Mtianeti/{$en}%20Municipality",
                    'ka' => "ხელისუფლება/ამომრჩეველი/მცხეთა-მთიანეთი/{$municipal_info['ka_full']}"
                ],
            ];
