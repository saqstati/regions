...
Multiselect.prototype = {
  ...
  _createItemList: function () {
    ...
    var selectAll = this._createItem("span", -1, window.location.pathname==='/regions/muncomEN.php' ?  "Select all" : 'ყველას მონიშვნა'  && window.location.pathname==='/regions/listEN.php' ?  "Select all" : 'ყველას მონიშვნა');
    // var selectAllReg = this._createItem("span", -1, window.location.pathname==='/regions/listEN.php' ?  "Select all" : 'ყველას მონიშვნა');
  ...
  _updateText: function (context) {
    ...
    if (
      ...
      val = window.location.pathname==='/regions/muncomEN.php' ?  " All Selected" : 'ყველა მონიშნულია' && window.location.pathname==='/regions/listEN.php' ?  "All Selected" : 'ყველა მონიშნულია';
    }
