        ...
        <table class="machveneblebi-left">
            ...
            <tbody>
                ...
                <tr class="informacia6">
                    ...
                    <td>
                        <span class="float-right"><a href="<?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? '/regions/municipal/ENG/Demography/Number%20of%20married%20people/C.%20Kutaisi.xlsx' : '/regions/municipal/დემოგრაფია/ქორწინების%20საშუალო%20ასაკი/ქ.%20ქუთაისი.xlsx'; ?>"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr class="informacia6">
                    <td>
                    ...
                    <td>
                        <span class="float-right"><a href="<?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? '/regions/municipal/ENG/Demography/Mean%20age%20of%20spouses/C.%20Kutaisi.xlsx' : '/regions/municipal/დემოგრაფია/რეგისტრირებულ%20ქორწინებათა%20რაოდენობა/ქ.%20ქუთაისი.xlsx'; ?>"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr>
                ...
                <tr class="informacia20">
                    ...
                    <td>
                        <span class="float-right"><a href="<?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? '/regions/municipal/ENG/Culture/Imereti/C.%20Kutaisi.xlsx' : '/regions/municipal/კულტურა/იმერეთი/ქ.%20ქუთაისი.xlsx'; ?>"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr class="informacia20">
                    <td>
                ...
                <tr class="informacia20">
                    ...
                    <td>
                        <span class="float-right"><a href="<?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? '/regions/municipal/ENG/Culture/Imereti/C.%20Kutaisi.xlsx' : '/regions/municipal/სოციალური%20სტატისტიკა/რეგისტრირებული%20და%20საარსებო%20შემწეობის%20მიმღები%20ოჯახების%20რაოდენობა/იმერეთი/ქ.%20ქუთაისი.xlsx'; ?>"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr>
            ...
            <svg id="svg4380" xmlns="http://www.w3.org/2000/svg" viewBox="" version="1.1">
                ...
                <g id="layer6" style="transform: scale(9.4);-webkit-transform-origin-x: 856px;-webkit-transform-origin-y: 628px;">
                    ...
                    <a xlink:href="../imereti.php" class="text-decoration-none">
                        ...
                        <?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? 'Kutaisi' : 'ქ.%20ქუთაისი'; ?>
                        </text>
                    </a>
