...
<div class="col-12 col-md-3">
    <table class="table">
        ...
        if (strpos($current_page, 'kutaisi') !== false) {
            $municipal_info = [
                'en_name' => 'C. Kutaisi',
                'en_full' => 'C. Kutaisi Municipality',
                'en_short' => 'C. Kutaisi', // used in some paths
                'ka_name' => 'ქ. ქუთაისი',
                'ka_full' => 'ქ. ქუთაისის მუნიციპალიტეტი',
                'ka_short' => 'ქუთაისი' // used when "ქ." prefix causes issues
            ];
        } elseif (strpos($current_page, 'bagdadi') !== false || strpos($current_page, 'baghdati') !== false) {
            $municipal_info = [
                'en_name' => 'Baghdati',
                'en_full' => 'Baghdati Municipality',
                'en_short' => 'Baghdati',
                'ka_name' => 'ბაღდათი',
                'ka_full' => 'ბაღდათის მუნიციპალიტეტი',
                'ka_short' => 'ბაღდათი'
            ];
        } elseif (strpos($current_page, 'chiatura') !== false || strpos($current_page, 'chiatura') !== false) {
            $municipal_info = [
                'en_name' => 'Chiatura',
                'en_full' => 'Chiatura Municipality',
                'en_short' => 'Chiatura',
                'ka_name' => 'ჭიათურა',
                'ka_full' => 'ჭიათურის მუნიციპალიტეტი',
                'ka_short' => 'ჭიათურა'
            ];
        } elseif (strpos($current_page, 'khoni') !== false) {
            $municipal_info = [
                'en_name' => 'Khoni',
                'en_full' => 'Khoni Municipality',
                'en_short' => 'Khoni',
                'ka_name' => 'ხონი',
                'ka_full' => 'ხონის მუნიციპალიტეტი',
                'ka_short' => 'ხონი'
            ];
        } elseif (strpos($current_page, 'sachxere') !== false || strpos($current_page, 'sachkhere') !== false) {
            $municipal_info = [
                'en_name' => 'Sachkhere',
                'en_full' => 'Sachkhere Municipality',
                'en_short' => 'Sachkhere',
                'ka_name' => 'საჩხერე',
                'ka_full' => 'საჩხერის მუნიციპალიტეტი',
                'ka_short' => 'საჩხერე'
            ];
        } elseif (strpos($current_page, 'samtredia') !== false || strpos($current_page, 'samtredia') !== false) {
            $municipal_info = [
                'en_name' => 'Samtredia',
                'en_full' => 'Samtredia Municipality',
                'en_short' => 'Samtredia',
                'ka_name' => 'სამტრედია',
                'ka_full' => 'სამტრედიის მუნიციპალიტეტი',
                'ka_short' => 'სამტრედია'
            ];
        } elseif (strpos($current_page, 'terjola') !== false) {
            $municipal_info = [
                'en_name' => 'Terjola',
                'en_full' => 'Terjola Municipality',
                'en_short' => 'Terjola',
                'ka_name' => 'თერჯოლა',
                'ka_full' => 'თერჯოლის მუნიციპალიტეტი',
                'ka_short' => 'თერჯოლა'
            ];
        } elseif (strpos($current_page, 'tyibuli') !== false || strpos($current_page, 'tkibuli') !== false) {
            $municipal_info = [
                'en_name' => 'Tkibuli',
                'en_full' => 'Tkibuli Municipality',
                'en_short' => 'Tkibuli',
                'ka_name' => 'ტყიბული',
                'ka_full' => 'ტყიბულის მუნიციპალიტეტი',
                'ka_short' => 'ტყიბული'
            ];
        } elseif (strpos($current_page, 'wyaltubo') !== false || strpos($current_page, 'tskaltubo') !== false) {
            $municipal_info = [
                'en_name' => 'Tskaltubo',
                'en_full' => 'Tskaltubo Municipality',
                'en_short' => 'Tskaltubo',
                'ka_name' => 'წყალტუბო',
                'ka_full' => 'წყალტუბოს მუნიციპალიტეტი',
                'ka_short' => 'წყალტუბო'
            ];
        } elseif (strpos($current_page, 'vani') !== false) {
            $municipal_info = [
                'en_name' => 'Vani',
                'en_full' => 'Vani Municipality',
                'en_short' => 'Vani',
                'ka_name' => 'ვანი',
            ...
            $municipal_info = [
                ...
                'en_short' => 'Zestaponi',
                'ka_name' => 'ზესტაფონი',
                'ka_full' => 'ზესტაფონის მუნიციპალიტეტი',
                'ka_short' => 'ზესტაფონი'
            ];
        } elseif (strpos($current_page, 'xaragauli') !== false) {
            $municipal_info = [
                'en_name' => 'Kharagauli',
                'en_full' => 'Kharagauli Municipality',
                'en_short' => 'Kharagauli',
                'ka_name' => 'ხარაგაული',
                'ka_full' => 'ხარაგაულის მუნიციპალიტეტი',
                'ka_short' => 'ხარაგაული'
            ];
        } else {
            // Fallback
         ...
         * ======================= */
                ...
                'main_info_admin' => [
                    'en' => "ENG/Main%20Information/Administrative%20structure/Imereti/{$enShort}",
                    'ka' => "ძირითადი%20ინფორმაცია/ადმინისტრაციული%20მოწყობა/იმერეთი/{$ka}"
                ],
         ...
         * ======================= */
                'employment_employed' => [
                    'en' => "ENG/Employment%20and%20Wages/Employed%20persons/Imereti/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/დასაქმებულები/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'employment_employees' => [
                    'en' => "ENG/Employment%20and%20Wages/Employees/Imereti/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/დაქირავებულები/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'employment_salary' => [
                    'en' => "ENG/Employment%20and%20Wages/Average%20monthly%20remuneration/Imereti/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/ხელფასი/იმერეთი/{$municipal_info['ka_name']}"
                ],
         ...
         * ======================= */
                'business_investments_fixed' => [
                    'en' => "ENG/Business%20Sector/Investments%20in%20fixed%20assets/Imereti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ინვესტიციები/იმერეთი/{$municipal_info['ka_name']}"
                ],
         ...
         * ======================= */
                ...
                'birth_stillbirths_by_sex' => [
                    'en' => "ENG/Demography/Number%20of%20stillbirths%20by%20sex/Imereti/{$en}",
                    'ka' => "დემოგრაფია/მკვდართშობილები%20სქესის%20მიხედვით/იმერეთი/{$municipal_info['ka_name']}"
                ],
         ...
         * ======================= */
                'business_turnover' => [
                    'en' => "ENG/Business%20Sector/turnover/Imereti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ბრუნვა/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'business_production' => [
                    'en' => "ENG/Business%20Sector/Production%20Value/Imereti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/პროდუქციის%20გამოშვება/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'business_personnel_costs' => [
                    'en' => "ENG/Business%20Sector/Pesronal%20Costs/Imereti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/შრომითი%20დანახარჯები/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'business_purchases' => [
                    'en' => "ENG/Business%20Sector/Purchase%20of%20good%20and%20services/Imereti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/საქონლისა%20და%20მომსახურების%20ყიდვები/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'business_purchases_resale' => [
                    'en' => "ENG/Business%20Sector/Purchase%20of%20good%20and%20services%20for%20resale/Imereti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/გადასაყიდად%20განკუთვნილი%20საქონლისა%20და%20მომსახურების%20ყიდვები/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'business_value_added' => [
                    'en' => "ENG/Business%20Sector/Value%20added/Imereti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/დამატებული%20ღირებულება/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'business_intermediate' => [
                    'en' => "ENG/Business%20Sector/Intermediate%20consumption/Imereti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/შუალედური%20მოხმარება/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'business_investment' => [
                    'en' => "ENG/Business%20Sector/Investment%20in%20fixed%20assets/Imereti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ინვესტიცია%20ძირითად%20კაპიტალში/იმერეთი/{$municipal_info['ka_name']}"
                ],
         ...
         * ======================= */
                'budget_main' => [
                    'en' => "ENG/Budget/Imereti/{$en}",
                    'ka' => "ბიუჯეტი/იმერეთი/{$municipal_info['ka_name']}"
                ],
         ...
         * ======================= */
                'construction_permissions' => [
                    'en' => "ENG/Construction/Permissions%20granted/Imereti/{$en}%20Municipality",
                    'ka' => "მშენებლობა/მშენებლობაზე%20გაცემული%20ნებართვები/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'construction_completed' => [
                    'en' => "ENG/Construction/Completed%20Construction/Imereti/{$en}%20Municipality",
                    'ka' => "მშენებლობა/დასრულებული%20მშენებლობა/იმერეთი/{$municipal_info['ka_name']}"
                ],
         ...
         * ======================= */
                'trading_markets_legal' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20organizational%20legal%20forms%20in%20Georgia/Imereti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ორგანიზაციულ-სამართლებლივი%20ფორმების%20მიხედვით/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_ownership' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20ownership%20type%20in%20Georgia/Imereti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20საკუთრების%20ფორმის%20მიხედვით/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_type' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20type%20in%20Georgia/Imereti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ტიპების%20მიხედვით/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_days' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20on%20days%20of%20trade/Imereti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ვაჭრობის%20დღეთა%20მიხედვით/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'trading_employed' => [
                    'en' => "ENG/Trading/Average%20annual%20number%20of%20employed%20persons/Imereti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20დირექციებში%20დასაქმებულთა%20რაოდენობა/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'trading_sellers' => [
                    'en' => "ENG/Trading/Number%20of%20market-place%20and%20sellers%20on%20the%20markets%20and%20fairs/Imereti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრებში%20და%20ბაზრობებში%20სავაჭრო%20ადგილების%20და%20მოვაჭრეთა%20რაოდენობა/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'trading_financial' => [
                    'en' => "ENG/Trading/Financial%20indices%20of%20markets%20and%20fairs/Imereti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20საფინანსო%20მაჩვენებლები/იმერეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'transport_roads' => [
                    'en' => "ENG/TransportAndStorage/Length%20of%20transport%20ways/Imereti/{$en}%20Municipality",
                    'ka' => "ტრანსპორტი%20და%20დასაწყობება/საერთო%20სარგებლობის%20საავტომობილო%20გზების%20სიგრძე/იმერეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'tourism_domestic' => [
                    'en' => "ENG/Tourism/Imereti/{$en}",
                    'ka' => "ტურიზმი/იმერეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'healthcare_indicators' => [
                    'en' => "ENG/Healthcare/Indicators/Imereti/{$en}",
                    'ka' => "ჯანდაცვა/მაჩვენებლები/იმერეთი/{$kaSafe}"
                ],
                'healthcare_emergent' => [
                    'en' => "ENG/Healthcare/Emergent/Imereti/{$en}",
                    'ka' => "ჯანდაცვა/სასწრაფო/იმერეთი/{$kaSafe}"
                ],
                'healthcare_abortions' => [
                    'en' => "ENG/Healthcare/Abortions/Imereti/{$en}",
                    'ka' => "ჯანდაცვა/აბორტები/იმერეთი/{$kaSafe}"
                ],
                'healthcare_anemia' => [
                    'en' => "ENG/Healthcare/Anemia/Imereti/{$en}",
                    'ka' => "ჯანდაცვა/ანემია/იმერეთი/{$kaSafe}"
                ],
                'healthcare_diabetes' => [
                    'en' => "ENG/Healthcare/Diabetes/Imereti/{$en}",
                    'ka' => "ჯანდაცვა/დიაბეტი/იმერეთი/{$kaSafe}"
                ],
                'healthcare_cancer' => [
                    'en' => "ENG/Healthcare/Cancer/Imereti/{$en}",
                    'ka' => "ჯანდაცვა/კიბო/იმერეთი/{$kaSafe}"
                ],
                'healthcare_circulatory' => [
                    'en' => "ENG/Healthcare/Circulatory/Imereti/{$en}",
                    'ka' => "ჯანდაცვა/სისხლის%20მიმოქცევა/იმერეთი/{$kaSafe}"
                ],
                'healthcare_respiratory' => [
                    'en' => "ENG/Healthcare/Respiratory/Imereti/{$en}",
                    'ka' => "ჯანდაცვა/სუნთქვა/იმერეთი/{$kaSafe}"
                ],
                'healthcare_syphilis' => [
                    'en' => "ENG/Healthcare/Syphilis/Imereti/{$en}",
                    'ka' => "ჯანდაცვა/ათაშანგი/იმერეთი/{$kaSafe}"
                ],
                'healthcare_aids' => [
                    'en' => "ENG/Healthcare/AIDS/Imereti/{$en}",
                    'ka' => "ჯანდაცვა/შიდსი/იმერეთი/{$kaSafe}"
                ],
                'healthcare_tuberculosis' => [
                    'en' => "ENG/Healthcare/Tuberculosis/Imereti/{$en}",
                    'ka' => "ჯანდაცვა/ტუბერკულიოზი/იმერეთი/{$kaSafe}"
                ],
                'healthcare_hepatitis' => [
                    'en' => "ENG/Healthcare/Hepatitis/Imereti/{$en}",
                    'ka' => "ჯანდაცვა/ჰეპატიტი/იმერეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                ...
                'social_subsistence' => [
                    'en' => "ENG/Social%20Statistic/Subsistence%20Allowance/Imereti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/საარსებო/იმერეთი/{$kaSafe}"
                ],
                'social_receiving' => [
                    'en' => "ENG/Social%20Statistic/Receiving/Imereti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/მიმღები/იმერეთი/{$kaSafe}"
                ],
                'social_beneficiaries' => [
                    'en' => "ENG/Social%20Statistic/Beneficiaries/Imereti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/ბენეფიციართა/იმერეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'education_preschool' => [
                    'en' => "ENG/Education/Preschool%20and%20Education%20Institutions/Imereti/{$en}",
                    'ka' => "განათლება/სკოლამდელი%20აღზრდისა%20და%20განათლების%20დაწესებულებები/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'education_general' => [
                    'en' => "ENG/Education/General%20Educational%20Institution/Imereti/{$en}",
                    'ka' => "განათლება/ზოგადსაგანმანათლებლო%20დაწესებულებები/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'education_status' => [
                    'en' => "ENG/Education/Status/Imereti/{$municipal_info['en_full']}",
                    'ka' => "განათლება/სტატუსი/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'education_directors' => [
                    'en' => "ENG/Education/Directors/Imereti/{$municipal_info['en_full']}",
                    'ka' => "განათლება/დირექტორები/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'education_vocational' => [
                    'en' => "ENG/Education/Vocational%20and%20Higher%20educational%20institutions/Adjara/{$en}",
                    'ka' => "განათლება/პროფესიული%20და%20უმაღლესი%20საგანმანათლებლო%20დაწესებულებები/Imereti/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'culture' => [
                    'en' => "ENG/Culture/Imereti/{$en}",
                    'ka' => "კულტურა/იმერეთი/{$municipal_info['ka_name']}"
                ],
         ...
         * ======================= */
                'business_register_entities' => [
                    'en' => "ENG/Business%20Register/Registered%20entities%20per%201000%20persons/Imereti/{$en}",
                    'ka' => "ბიზნეს%20რეგისტრი/რეგისტრირებული%20სუბიექტები/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'business_register_newly' => [
                    'en' => "ENG/Business%20Register/Number%20of%20newly%20registered%20business%20entities%20in%20Georgia/Imereti/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/ახლად%20რეგისტრირებული%20ბიზნეს%20სუბიექტები/იმერეთი/{$municipal_info['ka_name']}"
                ],
                'business_register_active' => [
                    'en' => "ENG/Business%20Register/Number%20of%20active%20business%20entities%20registered%20in%20Georgia/Imereti/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/ეკონომიკურად%20აქტიური%20ბიზნეს%20სუბიექტების%20რაოდენობა/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'business_register_public' => [
                    'en' => "ENG/Business%20Register/Number%20of%20public%20institutions/Imereti/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/საჯარო%20დაწესებულებების%20რაოდენობა/იმერეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'economic_activity_registered' => [
                    'en' => "ENG/byKindOfEconomicActivity/Number%20of%20registered%20entities%20by%20kind%20of%20economic%20activity/Imereti/{$en}",
                    'ka' => "ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/იმერეთი/{$kaSafe}"
                ],
                'economic_activity_active' => [
                    'en' => "ENG/byKindOfEconomicActivity/Number%20of%20active%20entities%20by%20kind%20of%20economic%20activity/Imereti/{$en}",
                    'ka' => "ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/იმერეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'ownership_registered' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20registered%20entities%20by%20ownership%20type/Imereti/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20საკუთრების%20ფორმების%20მიხედვით/იმერეთი/{$kaSafe}"
                ],
                'ownership_active_size' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20active%20entities%20by%20ownership%20type%20and%20size/Imereti/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20საკუთრების%20ფორმებისა%20და%20ზომების%20მიხედვით/იმერეთი/{$kaSafe}"
                ],
                'ownership_newly' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20entities%20newly%20registered%20in%20Georgia%20by%20ownership%20type/Imereti/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/ახლადრეგისტრირებულ%20სუბიექტთა%20რაოდენობა/იმერეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'organizational_registered' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20registered%20entities%20by%20organizational-legal%20form/Imereti/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/იმერეთი/{$kaSafe}"
                ],
                'organizational_active' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20active%20entities%20by%20organizational-legal%20form/Imereti/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვ/იმერეთი/{$kaSafe}"
                ],
                'organizational_newly' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20entities%20newly%20registered%20in%20Georgia%20by%20organizational-legal%20form/Imereti/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/ახლადრეგისტრირებულ%20სუბიექტთა%20რაოდენობა/იმერეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'agriculture_land' => [
                    'en' => "ENG/Share%20of%20Agriculture%20Land%20Area/Imereti/{$en}%20Municipality",
                    'ka' => "soflis%20meurneoba/ეკო_აქტ/იმერეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'hotels_accommodation' => [
                    'en' => "ENG/Hotels/Accommodation/Imereti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/სასტუმრო%20ობიექტები/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'hotels_visitors_residents' => [
                    'en' => "ENG/Hotels/Visitors%20Residents/Imereti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ვიზიტორები%20რეზიდენტები/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'hotels_visitors_nonresidents' => [
                    'en' => "ENG/Hotels/Visitors%20non%20residents/Imereti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ვიზიტორები%20არარეზიდენტები/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'hotels_nights_residents' => [
                    'en' => "ENG/Hotels/Nights%20spent%20Residents/Imereti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ღამეები%20რეზიდენტები/იმერეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'hotels_number_area' => [
                    'en' => "ENG/Hotels/Number%20of%20hotels%20and%20hotel-type%20establishments%20and%20their%20total%20area/Imereti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სასტუმროების%20რაოდენობა%20და%20ფართობი/იმერეთი/{$kaSafe}"
                ],
                'hotels_rooms' => [
                    'en' => "ENG/Hotels/Number%20of%20Rooms%20in%20Hotels%20and%20Hotel-type%20enterprises/Imereti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/ნომრების%20რაოდენობა%20სასტუმროებსა%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში/იმერეთი/{$kaSafe}"
                ],
                'hotels_guests' => [
                    'en' => "ENG/Hotels/Guests/Imereti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სტუმრები/იმერეთი/{$kaSafe}"
                ],
                'hotels_employees' => [
                    'en' => "ENG/Hotels/Number%20of%20Employees%20in%20Hotels%20and%20Hotel-type%20enterprises/Imereti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სასტუმროების%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში%20დასაქმებულთა%20რაოდენობა%20სქესის%20მიხედვით/იმერეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'social_indicators' => [
                    'en' => "ENG/Social%20Statistic/Indicators/Imereti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/მაჭვენებლები/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'social_disability' => [
                    'en' => "ENG/Social%20Statistic/Disability%20Persons/Imereti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/დევნილი%20შშმ%20პირები/იმერეთი/{$municipal_info['ka_full']}"
                ],
                'social_registered' => [
                    'en' => "ENG/Social%20Statistic/Disabilities%20Registered/Imereti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/რეგისტრირებული%20შშმ%20პირები/იმერეთი/{$municipal_info['ka_full']}"
                ],
