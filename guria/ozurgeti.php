        ...
        <table class="machveneblebi-left">
            ...
            <tbody>
                ...
                <tr class="informacia1">
                    ...
                    <td>
                        <span class="float-right"><a href="http://localhost/regions/municipal/fartobi/ozurgeTi.xlsx"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr class="informacia1">
                    <td>
                ...
                <tr class="informacia11">
                    ...
                    <td>
                        <span class="float-right"><a href="<?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? 'http://localhost/regions/municipal/ENG/Business%20Register/Number%20of%20newly%20registered%20business%20entities%20in%20Georgia%20per%201000%20population/Guria/Ozurgeti%20Municipality.xlsx' : 'http://localhost/regions/municipal/ბიზნეს%20რეგისტრი/წელიწადში%20რეგისტრირებული%20ახალი%20ბიზნეს%20სუბიექტების%20რაოდენობა%20მოსახლეობის%201000%20კაცზე/გურია/ოზურგეთის%20მუნიციპალიტეტი.xlsx'; ?>"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr class="informacia11">
                    <td>
                    ...
                    <td>
                        <span class="float-right"><a href="<?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? 'http://localhost/regions/municipal/ENG/Business%20Register/Number%20of%20active%20business%20entities%20registered%20in%20Georgia%20per%201000%20population/Guria/Ozurgeti%20Municipality.xlsx' : 'http://localhost/regions/municipal/ბიზნეს%20რეგისტრი/ეკონომიკურად%20აქტიური%20ბიზნეს%20სუბიექტების%20რაოდენობა%20მოსახლეობის%201000%20კაცზე/გურია/ოზურგეთის%20მუნიციპალიტეტი.xlsx'; ?>"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr class="informacia11">
                    <td>
                    ...
                    <td>
                        <span class="float-right"><a href="<?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? 'http://localhost/regions/municipal/ENG/Business%20Register/Number%20of%20public%20institutions%20per%201000%20population/Guria/Ozurgeti%20Municipality.xlsx' : 'http://localhost/regions/municipal/ბიზნეს%20რეგისტრი/საჯარო%20დაწესებულებების%20რაოდენობა%20მოსახლეობის%201000%20კაცზე/გურია/ოზურგეთის%20მუნიციპალიტეტი.xlsx'; ?>"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr>
                ...
                <tr class="informacia16">
                    ...
                    <td>
                        <span class="float-right"><a href="http://localhost/regions/municipal/mshenebloba/გაცემული_ნებართვები/გურია/ოზურგეთი.xlsx"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr class="informacia16">
                    <td>
                    ...
                    <td>
                        <span class="float-right"><a href="http://localhost/regions/municipal/mshenebloba/dasrulebuli_mshenebloba/გურია/ოზურგეთი.xlsx"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr>
