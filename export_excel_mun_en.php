<?php
	...
	$output .= strstr($key,'7') ? "<th>Death (men)</th>" : "" ;
	$output .= strstr($key,'8') ? "<th>General mortality rate (number of deaths per 1000 people)</th>" : "" ;
	$output .= strstr($key,'9') ? "<th>Number of employees in the business sector (thousands of people)</th>" : "" ;
	$output .= strstr($key,'10') ? "<th>Average monthly salary of employees in the business sector (GEL)</th>" : "" ;
	$output .= strstr($key,'11') ? "<th>Number of registered economic entities (unit)</th>" : "" ;
	$output .= strstr($key,'12') ? "<th>Number of active economic entities (unit)</th>" : "" ;
