...
<div class="col-12 col-md-3">
    <table class="table">
        ...
        if (strpos($current_page, 'axmeta') !== false) {
            $municipal_info = [
                'en_name' => 'Akhmeta',
                'en_full' => 'Akhmeta Municipality',
                'en_short' => 'Akhmeta', // used in some paths
                'ka_name' => 'ახმეტა',
                'ka_full' => 'ახმეტის მუნიციპალიტეტი',
                'ka_short' => 'ახმეტა' // used when "ქ." prefix causes issues
            ];
        } elseif (strpos($current_page, 'dedofliswyaro') !== false || strpos($current_page, 'dedoplistskaro') !== false) {
            $municipal_info = [
                'en_name' => 'Dedoplistskaro',
                'en_full' => 'Dedoplistskaro Municipality',
                'en_short' => 'Dedoplistskaro',
                'ka_name' => 'დედოფლისწყარო',
                'ka_full' => 'დედოფლისწყაროს მუნიციპალიტეტი',
                'ka_short' => 'დედოფლისწყარო'
            ];
        } elseif (strpos($current_page, 'gurjaani') !== false || strpos($current_page, 'gurjaani') !== false) {
            $municipal_info = [
                'en_name' => 'Gurjaani',
                'en_full' => 'Gurjaani Municipality',
                'en_short' => 'Gurjaani',
                'ka_name' => 'გურჯაანი',
                'ka_full' => 'გურჯაანის მუნიციპალიტეტი',
                'ka_short' => 'გურჯაანი'
            ];
        } elseif (strpos($current_page, 'lagodexi') !== false) {
            $municipal_info = [
                'en_name' => 'Lagodekhi',
                'en_full' => 'Lagodekhi Municipality',
                'en_short' => 'Lagodekhi',
                'ka_name' => 'ლაგოდეხი',
                'ka_full' => 'ლაგოდეხის მუნიციპალიტეტი',
                'ka_short' => 'ლაგოდეხი'
            ];
        } elseif (strpos($current_page, 'sagarejo') !== false || strpos($current_page, 'sagarejo') !== false) {
            $municipal_info = [
                'en_name' => 'Sagarejo',
                'en_full' => 'Sagarejo Municipality',
                'en_short' => 'Sagarejo',
                'ka_name' => 'საგარეჯო',
                'ka_full' => 'საგარეჯოს მუნიციპალიტეტი',
                'ka_short' => 'საგარეჯო'
            ];
        } elseif (strpos($current_page, 'signagi') !== false || strpos($current_page, 'sighnaghi') !== false) {
            $municipal_info = [
                'en_name' => 'Sighnaghi',
                'en_full' => 'Sighnaghi Municipality',
                'en_short' => 'Sighnaghi',
                'ka_name' => 'სიღნაღი',
                'ka_full' => 'სიღნაღის მუნიციპალიტეტი',
                'ka_short' => 'სიღნაღი'
            ];
        } elseif (strpos($current_page, 'telavi') !== false || strpos($current_page, 'telavi') !== false) {
            $municipal_info = [
                'en_name' => 'Telavi',
                'en_full' => 'Telavi Municipality',
                'en_short' => 'Telavi',
                'ka_name' => 'თელავი',
                'ka_full' => 'თელავის მუნიციპალიტეტი',
                'ka_short' => 'თელავი'
            ];
        } elseif (strpos($current_page, 'yvareli') !== false) {
            $municipal_info = [
                'en_name' => 'Kvareli',
                'en_full' => 'Kvareli Municipality',
                'en_short' => 'Kvareli',
                'ka_name' => 'ყვარელი',
                'ka_full' => 'ყვარლის მუნიციპალიტეტი',
                'ka_short' => 'ყვარელი'
            ];
        } else {
            // Fallback
         ...
         * ======================= */
                ...
                'main_info_admin' => [
                    'en' => "ENG/Main%20Information/Administrative%20structure/Kakheti/{$enShort}",
                    'ka' => "ძირითადი%20ინფორმაცია/ადმინისტრაციული%20მოწყობა/კახეთი/{$ka}"
                ],
         ...
         * ======================= */
                'pop_urban_rural' => [
                    'en' => "ENG/Population%20census%20pre/urban-rural%20settlements/Kakheti/{$en}",
                    'ka' => "მოსახლეობის%20აღწერა%20წინასწარი/მოსახლეობა%20საქალაქო-სასოფლო/კახეთი/{$kaSafe}"
                ],
                'pop_by_sex' => [
                    'en' => "ENG/Population%20census%20pre/number%20of%20population%20by%20sex/Kakheti/{$en}",
                    'ka' => "მოსახლეობის%20აღწერა%20წინასწარი/მოსახლეობა%20სქესის%20მიხედვით/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'employment_employed' => [
                    'en' => "ENG/Employment%20and%20Wages/Employed%20persons/Kakheti/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/დასაქმებულები/კახეთი/{$kaSafe}"
                ],
                'employment_employees' => [
                    'en' => "ENG/Employment%20and%20Wages/Employees/Kakheti/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/დაქირავებულები/კახეთი/{$kaSafe}"
                ],
                'employment_salary' => [
                    'en' => "ENG/Employment%20and%20Wages/Average%20monthly%20remuneration/Kakheti/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/ხელფასი/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'business_investments_fixed' => [
                    'en' => "ENG/Business%20Sector/Investments%20in%20fixed%20assets/Kakheti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ინვესტიციები/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                ...
                'birth_stillbirths_by_sex' => [
                    'en' => "ENG/Demography/Number%20of%20stillbirths%20by%20sex/Kakheti/{$en}",
                    'ka' => "დემოგრაფია/მკვდართშობილები%20სქესის%20მიხედვით/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'business_turnover' => [
                    'en' => "ENG/Business%20Sector/turnover/Kakheti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ბრუნვა/კახეთი/{$kaSafe}"
                ],
                'business_production' => [
                    'en' => "ENG/Business%20Sector/Production%20Value/Kakheti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/პროდუქციის%20გამოშვება/კახეთი/{$kaSafe}"
                ],
                'business_personnel_costs' => [
                    'en' => "ENG/Business%20Sector/Pesronal%20Costs/Kakheti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/შრომითი%20დანახარჯები/კახეთი/{$kaSafe}"
                ],
                'business_purchases' => [
                    'en' => "ENG/Business%20Sector/Purchase%20of%20good%20and%20services/Kakheti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/საქონლისა%20და%20მომსახურების%20ყიდვები/კახეთი/{$kaSafe}"
                ],
                'business_purchases_resale' => [
                    'en' => "ENG/Business%20Sector/Purchase%20of%20good%20and%20services%20for%20resale/Kakheti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/გადასაყიდად%20განკუთვნილი%20საქონლისა%20და%20მომსახურების%20ყიდვები/კახეთი/{$kaSafe}"
                ],
                'business_value_added' => [
                    'en' => "ENG/Business%20Sector/Value%20added/Kakheti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/დამატებული%20ღირებულება/კახეთი/{$kaSafe}"
                ],
                'business_intermediate' => [
                    'en' => "ENG/Business%20Sector/Intermediate%20consumption/Kakheti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/შუალედური%20მოხმარება/კახეთი/{$kaSafe}"
                ],
                'business_investment' => [
                    'en' => "ENG/Business%20Sector/Investment%20in%20fixed%20assets/Kakheti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ინვესტიცია%20ძირითად%20კაპიტალში/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'budget_main' => [
                    'en' => "ENG/Budget/Kakheti/{$en}",
                    'ka' => "ბიუჯეტი/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'construction_permissions' => [
                    'en' => "ENG/Construction/Permissions%20granted/Kakheti/{$en}%20Municipality",
                    'ka' => "მშენებლობა/მშენებლობაზე%20გაცემული%20ნებართვები/კახეთი/{$kaSafe}"
                ],
                'construction_completed' => [
                    'en' => "ENG/Construction/Completed%20Construction/Kakheti/{$en}%20Municipality",
                    'ka' => "მშენებლობა/დასრულებული%20მშენებლობა/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'trading_markets_legal' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20organizational%20legal%20forms%20in%20Georgia/Kakheti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ორგანიზაციულ-სამართლებლივი%20ფორმების%20მიხედვით/კახეთი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_ownership' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20ownership%20type%20in%20Georgia/Kakheti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20საკუთრების%20ფორმის%20მიხედვით/კახეთი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_type' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20type%20in%20Georgia/Kakheti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ტიპების%20მიხედვით/კახეთი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_days' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20on%20days%20of%20trade/Kakheti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ვაჭრობის%20დღეთა%20მიხედვით/კახეთი/{$municipal_info['ka_full']}"
                ],
                'trading_employed' => [
                    'en' => "ENG/Trading/Average%20annual%20number%20of%20employed%20persons/Kakheti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20დირექციებში%20დასაქმებულთა%20რაოდენობა/კახეთი/{$municipal_info['ka_full']}"
                ],
                'trading_sellers' => [
                    'en' => "ENG/Trading/Number%20of%20market-place%20and%20sellers%20on%20the%20markets%20and%20fairs/Kakheti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრებში%20და%20ბაზრობებში%20სავაჭრო%20ადგილების%20და%20მოვაჭრეთა%20რაოდენობა/კახეთი/{$municipal_info['ka_full']}"
                ],
                'trading_financial' => [
                    'en' => "ENG/Trading/Financial%20indices%20of%20markets%20and%20fairs/Kakheti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20საფინანსო%20მაჩვენებლები/კახეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'transport_roads' => [
                    'en' => "ENG/TransportAndStorage/Length%20of%20transport%20ways/Kakheti/{$en}%20Municipality",
                    'ka' => "ტრანსპორტი%20და%20დასაწყობება/საერთო%20სარგებლობის%20საავტომობილო%20გზების%20სიგრძე/კახეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'tourism_domestic' => [
                    'en' => "ENG/Tourism/Kakheti/{$en}",
                    'ka' => "ტურიზმი/კახეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'healthcare_indicators' => [
                    'en' => "ENG/Healthcare/Indicators/Kakheti/{$en}",
                    'ka' => "ჯანდაცვა/მაჩვენებლები/კახეთი/{$kaSafe}"
                ],
                'healthcare_emergent' => [
                    'en' => "ENG/Healthcare/Emergent/Kakheti/{$en}",
                    'ka' => "ჯანდაცვა/სასწრაფო/კახეთი/{$kaSafe}"
                ],
                'healthcare_abortions' => [
                    'en' => "ENG/Healthcare/Abortions/Kakheti/{$en}",
                    'ka' => "ჯანდაცვა/აბორტები/კახეთი/{$kaSafe}"
                ],
                'healthcare_anemia' => [
                    'en' => "ENG/Healthcare/Anemia/Kakheti/{$en}",
                    'ka' => "ჯანდაცვა/ანემია/კახეთი/{$kaSafe}"
                ],
                'healthcare_diabetes' => [
                    'en' => "ENG/Healthcare/Diabetes/Kakheti/{$en}",
                    'ka' => "ჯანდაცვა/დიაბეტი/კახეთი/{$kaSafe}"
                ],
                'healthcare_cancer' => [
                    'en' => "ENG/Healthcare/Cancer/Kakheti/{$en}",
                    'ka' => "ჯანდაცვა/კიბო/კახეთი/{$kaSafe}"
                ],
                'healthcare_circulatory' => [
                    'en' => "ENG/Healthcare/Circulatory/Kakheti/{$en}",
                    'ka' => "ჯანდაცვა/სისხლის%20მიმოქცევა/კახეთი/{$kaSafe}"
                ],
                'healthcare_respiratory' => [
                    'en' => "ENG/Healthcare/Respiratory/Kakheti/{$en}",
                    'ka' => "ჯანდაცვა/სუნთქვა/კახეთი/{$kaSafe}"
                ],
                'healthcare_syphilis' => [
                    'en' => "ENG/Healthcare/Syphilis/Kakheti/{$en}",
                    'ka' => "ჯანდაცვა/ათაშანგი/კახეთი/{$kaSafe}"
                ],
                'healthcare_aids' => [
                    'en' => "ENG/Healthcare/AIDS/Kakheti/{$en}",
                    'ka' => "ჯანდაცვა/შიდსი/კახეთი/{$kaSafe}"
                ],
                'healthcare_tuberculosis' => [
                    'en' => "ENG/Healthcare/Tuberculosis/Kakheti/{$en}",
                    'ka' => "ჯანდაცვა/ტუბერკულიოზი/კახეთი/{$kaSafe}"
                ],
                'healthcare_hepatitis' => [
                    'en' => "ENG/Healthcare/Hepatitis/Kakheti/{$en}",
                    'ka' => "ჯანდაცვა/ჰეპატიტი/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                ...
                'social_subsistence' => [
                    'en' => "ENG/Social%20Statistic/Subsistence%20Allowance/Kakheti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/საარსებო/კახეთი/{$kaSafe}"
                ],
                'social_receiving' => [
                    'en' => "ENG/Social%20Statistic/Receiving/Kakheti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/მიმღები/კახეთი/{$kaSafe}"
                ],
                'social_beneficiaries' => [
                    'en' => "ENG/Social%20Statistic/Beneficiaries/Kakheti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/ბენეფიციართა/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'education_preschool' => [
                    'en' => "ENG/Education/Preschool%20and%20Education%20Institutions/Kakheti/{$en}",
                    'ka' => "განათლება/სკოლამდელი%20აღზრდისა%20და%20განათლების%20დაწესებულებები/კახეთი/{$municipal_info['ka_full']}"
                ],
                'education_general' => [
                    'en' => "ENG/Education/General%20Educational%20Institution/Kakheti/{$en}",
                    'ka' => "განათლება/ზოგადსაგანმანათლებლო%20დაწესებულებები/კახეთი/{$kaSafe}"
                ],
                'education_status' => [
                    'en' => "ENG/Education/Status/Kakheti/{$municipal_info['en_full']}",
                    'ka' => "განათლება/სტატუსი/კახეთი/{$municipal_info['ka_full']}"
                ],
                'education_directors' => [
                    'en' => "ENG/Education/Directors/Kakheti/{$municipal_info['en_full']}",
                    'ka' => "განათლება/დირექტორები/კახეთი/{$municipal_info['ka_full']}"
                ],
                'education_vocational' => [
                    'en' => "ENG/Education/Vocational%20and%20Higher%20educational%20institutions/Adjara/{$en}",
                    'ka' => "განათლება/პროფესიული%20და%20უმაღლესი%20საგანმანათლებლო%20დაწესებულებები/კახეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'culture' => [
                    'en' => "ENG/Culture/Kakheti/{$en}",
                    'ka' => "კულტურა/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                ...
                'trading_financial_indices' => [
                    'en' => "ENG/Trading/Financial%20indices%20of%20markets%20and%20fairs/Kakheti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20საფინანსო%20მაჩვენებლები/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'business_register_entities' => [
                    'en' => "ENG/Business%20Register/Registered%20entities%20per%201000%20persons/Kakheti/{$en}",
                    'ka' => "ბიზნეს%20რეგისტრი/რეგისტრირებული%20სუბიექტები/კახეთი/{$municipal_info['ka_full']}"
                ],
                'business_register_newly' => [
                    'en' => "ENG/Business%20Register/Number%20of%20newly%20registered%20business%20entities%20in%20Georgia/Kakheti/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/ახლად%20რეგისტრირებული%20ბიზნეს%20სუბიექტები/კახეთი/{$kaSafe}"
                ],
                'business_register_active' => [
                    'en' => "ENG/Business%20Register/Number%20of%20active%20business%20entities%20registered%20in%20Georgia/Kakheti/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/ეკონომიკურად%20აქტიური%20ბიზნეს%20სუბიექტების%20რაოდენობა/კახეთი/{$municipal_info['ka_full']}"
                ],
                'business_register_public' => [
                    'en' => "ENG/Business%20Register/Number%20of%20public%20institutions/Kakheti/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/საჯარო%20დაწესებულებების%20რაოდენობა/კახეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'economic_activity_registered' => [
                    'en' => "ENG/byKindOfEconomicActivity/Number%20of%20registered%20entities%20by%20kind%20of%20economic%20activity/Kakheti/{$en}",
                    'ka' => "ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/კახეთი/{$kaSafe}"
                ],
                'economic_activity_active' => [
                    'en' => "ENG/byKindOfEconomicActivity/Number%20of%20active%20entities%20by%20kind%20of%20economic%20activity/Kakheti/{$en}",
                    'ka' => "ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'ownership_registered' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20registered%20entities%20by%20ownership%20type/Kakheti/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20საკუთრების%20ფორმების%20მიხედვით/კახეთი/{$kaSafe}"
                ],
                'ownership_active_size' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20active%20entities%20by%20ownership%20type%20and%20size/Kakheti/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20საკუთრების%20ფორმებისა%20და%20ზომების%20მიხედვით/კახეთი/{$kaSafe}"
                ],
                'ownership_newly' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20entities%20newly%20registered%20in%20Georgia%20by%20ownership%20type/Kakheti/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/ახლადრეგისტრირებულ%20სუბიექტთა%20რაოდენობა/კახეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'organizational_registered' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20registered%20entities%20by%20organizational-legal%20form/Kakheti/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/კახეთი/{$kaSafe}"
                ],
                'organizational_active' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20active%20entities%20by%20organizational-legal%20form/Kakheti/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვ/კახეთი/{$kaSafe}"
                ],
                'organizational_newly' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20entities%20newly%20registered%20in%20Georgia%20by%20organizational-legal%20form/Kakheti/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/ახლადრეგისტრირებულ%20სუბიექტთა%20რაოდენობა/კახეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'agriculture_land' => [
                    'en' => "ENG/Share%20of%20Agriculture%20Land%20Area/Kakheti/{$en}%20Municipality",
                    'ka' => "soflis%20meurneoba/ეკო_აქტ/კახეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'hotels_accommodation' => [
                    'en' => "ENG/Hotels/Accommodation/Kakheti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/სასტუმრო%20ობიექტები/კახეთი/{$municipal_info['ka_full']}"
                ],
                'hotels_visitors_residents' => [
                    'en' => "ENG/Hotels/Visitors%20Residents/Kakheti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ვიზიტორები%20რეზიდენტები/კახეთი/{$municipal_info['ka_full']}"
                ],
                'hotels_visitors_nonresidents' => [
                    'en' => "ENG/Hotels/Visitors%20non%20residents/Kakheti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ვიზიტორები%20არარეზიდენტები/კახეთი/{$municipal_info['ka_full']}"
                ],
                'hotels_nights_residents' => [
                    'en' => "ENG/Hotels/Nights%20spent%20Residents/Kakheti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ღამეები%20რეზიდენტები/კახეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'hotels_number_area' => [
                    'en' => "ENG/Hotels/Number%20of%20hotels%20and%20hotel-type%20establishments%20and%20their%20total%20area/Kakheti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სასტუმროების%20რაოდენობა%20და%20ფართობი/კახეთი/{$kaSafe}"
                ],
                'hotels_rooms' => [
                    'en' => "ENG/Hotels/Number%20of%20Rooms%20in%20Hotels%20and%20Hotel-type%20enterprises/Kakheti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/ნომრების%20რაოდენობა%20სასტუმროებსა%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში/კახეთი/{$kaSafe}"
                ],
                'hotels_guests' => [
                    'en' => "ENG/Hotels/Guests/Kakheti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სტუმრები/კახეთი/{$kaSafe}"
                ],
                'hotels_employees' => [
                    'en' => "ENG/Hotels/Number%20of%20Employees%20in%20Hotels%20and%20Hotel-type%20enterprises/Kakheti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სასტუმროების%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში%20დასაქმებულთა%20რაოდენობა%20სქესის%20მიხედვით/კახეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'social_indicators' => [
                    'en' => "ENG/Social%20Statistic/Indicators/Kakheti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/მაჭვენებლები/კახეთი/{$municipal_info['ka_full']}"
                ],
                'social_disability' => [
                    'en' => "ENG/Social%20Statistic/Disability%20Persons/Kakheti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/დევნილი%20შშმ%20პირები/კახეთი/{$municipal_info['ka_full']}"
                ],
                'social_registered' => [
                    'en' => "ENG/Social%20Statistic/Disabilities%20Registered/Kakheti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/რეგისტრირებული%20შშმ%20პირები/კახეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'self_governance' => [
                    'en' => "ENG/Government/Self-Governance/Kakheti/{$en}%20Municipality",
                    'ka' => "ხელისუფლება/თვითმმართველობა/კახეთი/{$municipal_info['ka_full']}"
                ],
                'voters' => [
                    'en' => "ENG/Government/Voters/Kakheti/{$en}%20Municipality",
                    'ka' => "ხელისუფლება/ამომრჩეველი/კახეთი/{$municipal_info['ka_full']}"
                ],
            ];
