...
<div class="col-12 col-md-3">
    <table class="table">
        ...
        if (strpos($current_page, 'poti') !== false) {
            $municipal_info = [
                'en_name' => 'C. Poti',
                'en_full' => 'C. Poti Municipality',
                'en_short' => 'C. Poti', // used in some paths
                'ka_name' => 'ქ. ფოთი',
                'ka_full' => 'ქ. ფოთის მუნიციპალიტეტი',
                'ka_short' => 'ფოთი' // used when "ქ." prefix causes issues
            ];
        } elseif (strpos($current_page, 'abasha') !== false || strpos($current_page, 'abasha') !== false) {
            $municipal_info = [
                'en_name' => 'Abasha',
                'en_full' => 'Abasha Municipality',
                'en_short' => 'Abasha',
                'ka_name' => 'აბაშა',
                'ka_full' => 'აბაშის მუნიციპალიტეტი',
                'ka_short' => 'აბაშა'
            ];
        } elseif (strpos($current_page, 'chxorowyu') !== false || strpos($current_page, 'chkhorotsku') !== false) {
            $municipal_info = [
                'en_name' => 'Chkhorotsku',
                'en_full' => 'Chkhorotsku Municipality',
                'en_short' => 'Chkhorotsku',
                'ka_name' => 'ჩხოროწყუ',
                'ka_full' => 'ჩხოროწყუს მუნიციპალიტეტი',
                'ka_short' => 'ჩხოროწყუ'
            ];
        } elseif (strpos($current_page, 'martvili') !== false) {
            $municipal_info = [
                'en_name' => 'Martvili',
                'en_full' => 'Martvili Municipality',
                'en_short' => 'Martvili',
                'ka_name' => 'მარტვილი',
                'ka_full' => 'მარტვილის მუნიციპალიტეტი',
                'ka_short' => 'მარტვილი'
            ];
        } elseif (strpos($current_page, 'mestia') !== false || strpos($current_page, 'mestia') !== false) {
            $municipal_info = [
                'en_name' => 'Mestia',
                'en_full' => 'Mestia Municipality',
                'en_short' => 'Mestia',
                'ka_name' => 'მესტია',
                'ka_full' => 'მესტიის მუნიციპალიტეტი',
                'ka_short' => 'მესტია'
            ];
        } elseif (strpos($current_page, 'senaki') !== false || strpos($current_page, 'senaki') !== false) {
            $municipal_info = [
                'en_name' => 'Senaki',
                'en_full' => 'Senaki Municipality',
                'en_short' => 'Senaki',
                'ka_name' => 'სენაკი',
                'ka_full' => 'სენაკის მუნიციპალიტეტი',
                'ka_short' => 'სენაკი'
            ];
        } elseif (strpos($current_page, 'walenjixa') !== false || strpos($current_page, 'tsalenjikha') !== false) {
            $municipal_info = [
                'en_name' => 'Tsalenjikha',
                'en_full' => 'Tsalenjikha Municipality',
                'en_short' => 'Tsalenjikha',
                'ka_name' => 'წალენჯიხა',
                'ka_full' => 'წალენჯიხის მუნიციპალიტეტი',
                'ka_short' => 'წალენჯიხა'
            ];
        } elseif (strpos($current_page, 'xobi') !== false) {
            $municipal_info = [
                'en_name' => 'Khobi',
                'en_full' => 'Khobi Municipality',
                'en_short' => 'Khobi',
                'ka_name' => 'ხობი',
                'ka_full' => 'ხობის მუნიციპალიტეტი',
                'ka_short' => 'ხობი'
            ];
        } elseif (strpos($current_page, 'zugdidi') !== false) {
            $municipal_info = [
                'en_name' => 'Zugdidi',
                'en_full' => 'Zugdidi Municipality',
                'en_short' => 'Zugdidi',
                'ka_name' => 'ზუგდიდი',
                'ka_full' => 'ზუგდიდის მუნიციპალიტეტი',
                'ka_short' => 'ზუგდიდი'
            ];
        } else {
            // Fallback
         ...
         * ======================= */
                ...
                'main_info_admin' => [
                    'en' => "ENG/Main%20Information/Administrative%20structure/Samegrelo-Zemo%20Svaneti/{$enShort}",
                    'ka' => "ძირითადი%20ინფორმაცია/ადმინისტრაციული%20მოწყობა/სამეგრელო-ზემო%20სვანეთი/{$ka}"
                ],
         ...
         * ======================= */
                'employment_employed' => [
                    'en' => "ENG/Employment%20and%20Wages/Employed%20persons/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/დასაქმებულები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
                'employment_employees' => [
                    'en' => "ENG/Employment%20and%20Wages/Employees/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/დაქირავებულები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
                'employment_salary' => [
                    'en' => "ENG/Employment%20and%20Wages/Average%20monthly%20remuneration/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/ხელფასი/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
         ...
         * ======================= */
                'business_investments_fixed' => [
                    'en' => "ENG/Business%20Sector/Investments%20in%20fixed%20assets/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ინვესტიციები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
         ...
         * ======================= */
                ...
                'birth_stillbirths_by_sex' => [
                    'en' => "ENG/Demography/Number%20of%20stillbirths%20by%20sex/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "დემოგრაფია/მკვდართშობილები%20სქესის%20მიხედვით/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'business_turnover' => [
                    'en' => "ENG/Business%20Sector/turnover/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ბრუნვა/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
                'business_production' => [
                    'en' => "ENG/Business%20Sector/Production%20Value/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/პროდუქციის%20გამოშვება/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
                'business_personnel_costs' => [
                    'en' => "ENG/Business%20Sector/Pesronal%20Costs/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/შრომითი%20დანახარჯები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
                'business_purchases' => [
                    'en' => "ENG/Business%20Sector/Purchase%20of%20good%20and%20services/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/საქონლისა%20და%20მომსახურების%20ყიდვები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
                'business_purchases_resale' => [
                    'en' => "ENG/Business%20Sector/Purchase%20of%20good%20and%20services%20for%20resale/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/გადასაყიდად%20განკუთვნილი%20საქონლისა%20და%20მომსახურების%20ყიდვები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
                'business_value_added' => [
                    'en' => "ENG/Business%20Sector/Value%20added/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/დამატებული%20ღირებულება/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
                'business_intermediate' => [
                    'en' => "ENG/Business%20Sector/Intermediate%20consumption/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/შუალედური%20მოხმარება/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
                'business_investment' => [
                    'en' => "ENG/Business%20Sector/Investment%20in%20fixed%20assets/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ინვესტიცია%20ძირითად%20კაპიტალში/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
         ...
         * ======================= */
                'construction_permissions' => [
                    'en' => "ENG/Construction/Permissions%20granted/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "მშენებლობა/მშენებლობაზე%20გაცემული%20ნებართვები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
                'construction_completed' => [
                    'en' => "ENG/Construction/Completed%20Construction/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "მშენებლობა/დასრულებული%20მშენებლობა/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
         ...
         * ======================= */
                'trading_markets_legal' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20organizational%20legal%20forms%20in%20Georgia/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ორგანიზაციულ-სამართლებლივი%20ფორმების%20მიხედვით/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_ownership' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20ownership%20type%20in%20Georgia/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20საკუთრების%20ფორმის%20მიხედვით/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_type' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20type%20in%20Georgia/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ტიპების%20მიხედვით/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_days' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20on%20days%20of%20trade/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ვაჭრობის%20დღეთა%20მიხედვით/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'trading_employed' => [
                    'en' => "ENG/Trading/Average%20annual%20number%20of%20employed%20persons/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20დირექციებში%20დასაქმებულთა%20რაოდენობა/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'trading_sellers' => [
                    'en' => "ENG/Trading/Number%20of%20market-place%20and%20sellers%20on%20the%20markets%20and%20fairs/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრებში%20და%20ბაზრობებში%20სავაჭრო%20ადგილების%20და%20მოვაჭრეთა%20რაოდენობა/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'trading_financial' => [
                    'en' => "ENG/Trading/Financial%20indices%20of%20markets%20and%20fairs/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20საფინანსო%20მაჩვენებლები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'transport_roads' => [
                    'en' => "ENG/TransportAndStorage/Length%20of%20transport%20ways/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "ტრანსპორტი%20და%20დასაწყობება/საერთო%20სარგებლობის%20საავტომობილო%20გზების%20სიგრძე/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'tourism_domestic' => [
                    'en' => "ENG/Tourism/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ტურიზმი/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'healthcare_indicators' => [
                    'en' => "ENG/Healthcare/Indicators/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ჯანდაცვა/მაჩვენებლები/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'healthcare_emergent' => [
                    'en' => "ENG/Healthcare/Emergent/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ჯანდაცვა/სასწრაფო/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'healthcare_abortions' => [
                    'en' => "ENG/Healthcare/Abortions/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ჯანდაცვა/აბორტები/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'healthcare_anemia' => [
                    'en' => "ENG/Healthcare/Anemia/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ჯანდაცვა/ანემია/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'healthcare_diabetes' => [
                    'en' => "ENG/Healthcare/Diabetes/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ჯანდაცვა/დიაბეტი/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'healthcare_cancer' => [
                    'en' => "ENG/Healthcare/Cancer/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ჯანდაცვა/კიბო/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'healthcare_circulatory' => [
                    'en' => "ENG/Healthcare/Circulatory/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ჯანდაცვა/სისხლის%20მიმოქცევა/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'healthcare_respiratory' => [
                    'en' => "ENG/Healthcare/Respiratory/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ჯანდაცვა/სუნთქვა/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'healthcare_syphilis' => [
                    'en' => "ENG/Healthcare/Syphilis/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ჯანდაცვა/ათაშანგი/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'healthcare_aids' => [
                    'en' => "ENG/Healthcare/AIDS/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ჯანდაცვა/შიდსი/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'healthcare_tuberculosis' => [
                    'en' => "ENG/Healthcare/Tuberculosis/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ჯანდაცვა/ტუბერკულიოზი/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'healthcare_hepatitis' => [
                    'en' => "ENG/Healthcare/Hepatitis/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ჯანდაცვა/ჰეპატიტი/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                ...
                'social_subsistence' => [
                    'en' => "ENG/Social%20Statistic/Subsistence%20Allowance/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/საარსებო/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'social_receiving' => [
                    'en' => "ENG/Social%20Statistic/Receiving/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/მიმღები/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'social_beneficiaries' => [
                    'en' => "ENG/Social%20Statistic/Beneficiaries/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/ბენეფიციართა/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'education_preschool' => [
                    'en' => "ENG/Education/Preschool%20and%20Education%20Institutions/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "განათლება/სკოლამდელი%20აღზრდისა%20და%20განათლების%20დაწესებულებები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'education_general' => [
                    'en' => "ENG/Education/General%20Educational%20Institution/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "განათლება/ზოგადსაგანმანათლებლო%20დაწესებულებები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
                'education_status' => [
                    'en' => "ENG/Education/Status/Samegrelo-Zemo%20Svaneti/{$municipal_info['en_full']}",
                    'ka' => "განათლება/სტატუსი/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'education_directors' => [
                ...
                'education_vocational' => [
                    ...
                    'ka' => "განათლება/პროფესიული%20და%20უმაღლესი%20საგანმანათლებლო%20დაწესებულებები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'culture' => [
                    'en' => "ENG/Culture/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "კულტურა/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
         ...
         * ======================= */
                'business_register_entities' => [
                    'en' => "ENG/Business%20Register/Registered%20entities%20per%201000%20persons/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ბიზნეს%20რეგისტრი/რეგისტრირებული%20სუბიექტები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'business_register_newly' => [
                    'en' => "ENG/Business%20Register/Number%20of%20newly%20registered%20business%20entities%20in%20Georgia/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/ახლად%20რეგისტრირებული%20ბიზნეს%20სუბიექტები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_name']}"
                ],
                'business_register_active' => [
                    'en' => "ENG/Business%20Register/Number%20of%20active%20business%20entities%20registered%20in%20Georgia/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/ეკონომიკურად%20აქტიური%20ბიზნეს%20სუბიექტების%20რაოდენობა/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'business_register_public' => [
                    'en' => "ENG/Business%20Register/Number%20of%20public%20institutions/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/საჯარო%20დაწესებულებების%20რაოდენობა/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'economic_activity_registered' => [
                    'en' => "ENG/byKindOfEconomicActivity/Number%20of%20registered%20entities%20by%20kind%20of%20economic%20activity/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'economic_activity_active' => [
                    'en' => "ENG/byKindOfEconomicActivity/Number%20of%20active%20entities%20by%20kind%20of%20economic%20activity/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'ownership_registered' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20registered%20entities%20by%20ownership%20type/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20საკუთრების%20ფორმების%20მიხედვით/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'ownership_active_size' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20active%20entities%20by%20ownership%20type%20and%20size/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20საკუთრების%20ფორმებისა%20და%20ზომების%20მიხედვით/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'ownership_newly' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20entities%20newly%20registered%20in%20Georgia%20by%20ownership%20type/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/ახლადრეგისტრირებულ%20სუბიექტთა%20რაოდენობა/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'organizational_registered' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20registered%20entities%20by%20organizational-legal%20form/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'organizational_active' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20active%20entities%20by%20organizational-legal%20form/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვ/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'organizational_newly' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20entities%20newly%20registered%20in%20Georgia%20by%20organizational-legal%20form/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/ახლადრეგისტრირებულ%20სუბიექტთა%20რაოდენობა/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'agriculture_land' => [
                    'en' => "ENG/Share%20of%20Agriculture%20Land%20Area/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "soflis%20meurneoba/ეკო_აქტ/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'hotels_accommodation' => [
                    'en' => "ENG/Hotels/Accommodation/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/სასტუმრო%20ობიექტები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'hotels_visitors_residents' => [
                    'en' => "ENG/Hotels/Visitors%20Residents/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ვიზიტორები%20რეზიდენტები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'hotels_visitors_nonresidents' => [
                    'en' => "ENG/Hotels/Visitors%20non%20residents/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ვიზიტორები%20არარეზიდენტები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'hotels_nights_residents' => [
                    'en' => "ENG/Hotels/Nights%20spent%20Residents/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ღამეები%20რეზიდენტები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'hotels_number_area' => [
                    'en' => "ENG/Hotels/Number%20of%20hotels%20and%20hotel-type%20establishments%20and%20their%20total%20area/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სასტუმროების%20რაოდენობა%20და%20ფართობი/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'hotels_rooms' => [
                    'en' => "ENG/Hotels/Number%20of%20Rooms%20in%20Hotels%20and%20Hotel-type%20enterprises/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/ნომრების%20რაოდენობა%20სასტუმროებსა%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'hotels_guests' => [
                    'en' => "ENG/Hotels/Guests/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სტუმრები/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
                'hotels_employees' => [
                    'en' => "ENG/Hotels/Number%20of%20Employees%20in%20Hotels%20and%20Hotel-type%20enterprises/Samegrelo-Zemo%20Svaneti/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სასტუმროების%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში%20დასაქმებულთა%20რაოდენობა%20სქესის%20მიხედვით/სამეგრელო-ზემო%20სვანეთი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'social_indicators' => [
                    'en' => "ENG/Social%20Statistic/Indicators/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/მაჭვენებლები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'social_disability' => [
                    'en' => "ENG/Social%20Statistic/Disability%20Persons/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/დევნილი%20შშმ%20პირები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
                'social_registered' => [
                    'en' => "ENG/Social%20Statistic/Disabilities%20Registered/Samegrelo-Zemo%20Svaneti/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/რეგისტრირებული%20შშმ%20პირები/სამეგრელო-ზემო%20სვანეთი/{$municipal_info['ka_full']}"
                ],
