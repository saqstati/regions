...
<body>
    ...
    <div class="main-container">
        ...
        <header class="header1">
            <h1>
                <p id="pagetitlename" class="tr" Key="REGION14"><?php echo $lang['senakititlename'] ?></p>
            </h1>
        </header>
        <div id="languages">
            <a href="senaki.php?lang=ka" id="ka" class="lang"><img src="../images/ka.png" /></a>
            <a href="senaki.php?lang=en" id="en" class="lang"><img src="../images/en.png" /></a>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    <td id="dziritadi20" title="" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover" data-bs-content=""><?php echo $healthCareAndSocialSecurity['2']; ?>
                        <span class="float-right"><a href="<?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? '/regions/municipal/ENG/Healthcare/Samegrelo-Zemo%20Svaneti/Senaki.xlsx' : '/regions/municipal/ჯანდაცვა/სამეგრელო-ზემო%20სვანეთი/სენაკი.xlsx'; ?>"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr>
                    <td id="dziritadi21" title="" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover" data-bs-content=""><?php echo $healthCareAndSocialSecurity['11']; ?>
                        <span class="float-right"><a href="<?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? '/regions/municipal/ENG/Social%20Statistic/Samegrelo-Zemo%20Svaneti/Senaki.xlsx' : '/regions/municipal/სოციალური%20სტატისტიკა/სამეგრელო-ზემო%20სვანეთი/სენაკის%20მუნიციპალიტეტი.xlsx'; ?>"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr>
        ...
        <table class="machveneblebi-right">
            ...
            $query = mysqli_query($link, "select * from `municipalities` where ID = 5");
