...
<body>
    ...
    <div class="main-container">
        ...
        <header class="header1">
            <h1>
                <p id="pagetitlename" class="tr" Key="REGION14"><?php echo $lang['adjaratitlename'] ?></p>
            </h1>
        </header>
        <div id="languages">
            <a href="adjara.php?lang=ka" id="ka" class="lang"><img src="images/ka.png" /></a>
            <a href="adjara.php?lang=en" id="en" class="lang"><img src="images/en.png" /></a>
        </div>
        ...
        <table class="machveneblebi-left">
            ...
            <tbody>
                ...
                <tr>
                    <td id="dziritadi16" onclick="GetIdChange()" title="" data-toggle="popover" data-placement="top" data-trigger="hover" data-content="<?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? 'According to C. Batumi' : 'ქ. ბათუმის მიხედვით'; ?>"><?php echo $pricesAndInflation[1]; ?>
                    </td>
                </tr>
