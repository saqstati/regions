        ...
        <table class="machveneblebi-left">
            ...
            <tbody>
                ...
                <tr class="informacia1">
                    ...
                    <td>
                        <span class="float-right"><a href="http://localhost/regions/municipal/fartobi/ninowminda.xlsx"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr class="informacia1">
                    <td>
                ...
                <tr class="informacia15">
                    ...
                    <td>
                        <span class="float-right"><a href="<?php echo (isset($_GET['lang']) && $_GET['lang'] == 'en') ? 'http://localhost/regions/municipal/ENG/Share%20of%20Agriculture%20Land%20Area/Samtskhe-Javakheti/Ninotsminda%20Municipality.xlsx' : 'http://localhost/regions/municipal/soflis%20meurneoba/ეკო_აქტ/სამცხე-ჯავახეთი/ნინოწმინდის%20მუნიციპალიტეტი.xlsx'; ?>"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr>
                ...
                <tr class="informacia16">
                    ...
                    <td>
                        <span class="float-right"><a href="http://localhost/regions/municipal/mshenebloba/გაცემული_ნებართვები/სამცხე-ჯავახეთი/ნინოწმინდა.xlsx"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr class="informacia16">
                    <td>
                    ...
                    <td>
                        <span class="float-right"><a href="http://localhost/regions/municipal/mshenebloba/dasrulebuli_mshenebloba/სამცხე-ჯავახეთი/ნინოწმინდა.xlsx"> <img src="images/excel-9-24.png" alt="exel" width="25" height="25"> </a></span>
                    </td>
                </tr>
                <tr>
