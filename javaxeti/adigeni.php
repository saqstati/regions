...
<body>
    ...
    <div class="main-container">
        ...
        <header class="header1">
            <h1>
                <p id="pagetitlename" class="tr" Key="REGION14">სტატისტიკური ინფორმაცია სამცხე-ჯავახეთის რეგიონის ადიგენის შესახებ</p>
            </h1>
        </header>
        <div id="languages">
        ...
        <div class="map-box">
            <img src="maps/adigeni.svg" alt="adigeniSVG" id="adigeniSVG">
        </div>
