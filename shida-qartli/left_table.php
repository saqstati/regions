...
<div class="col-12 col-md-3">
    <table class="table">
        ...
        if (strpos($current_page, 'gori') !== false) {
            $municipal_info = [
                'en_name' => 'Gori',
                'en_full' => 'Gori Municipality',
                'en_short' => 'Gori', // used in some paths
                'ka_name' => 'გორი',
                'ka_full' => 'გორის მუნიციპალიტეტი',
                'ka_short' => 'გორი' // used when "ქ." prefix causes issues
            ];
        } elseif (strpos($current_page, 'kaspi') !== false || strpos($current_page, 'kaspi') !== false) {
            $municipal_info = [
                'en_name' => 'Kaspi',
                'en_full' => 'Kaspi Municipality',
                'en_short' => 'Kaspi',
                'ka_name' => 'კასპი',
                'ka_full' => 'კასპის მუნიციპალიტეტი',
                'ka_short' => 'კასპი'
            ];
        } elseif (strpos($current_page, 'qareli') !== false || strpos($current_page, 'kareli') !== false) {
            $municipal_info = [
                'en_name' => 'Kareli',
                'en_full' => 'Kareli Municipality',
                'en_short' => 'Kareli',
                'ka_name' => 'ქარელი',
                'ka_full' => 'ქარელის მუნიციპალიტეტი',
                'ka_short' => 'ქარელი'
            ];
        } elseif (strpos($current_page, 'xashuri') !== false || strpos($current_page, 'khashuri') !== false) {
            $municipal_info = [
                'en_name' => 'Khashuri',
                'en_full' => 'Khashuri Municipality',
                'en_short' => 'Khashuri',
                'ka_name' => 'ხაშური',
                'ka_full' => 'ხაშურის მუნიციპალიტეტი',
                'ka_short' => 'ხაშური'
            ];
        } else {
            // Fallback
         ...
         * ======================= */
                ...
                'main_info_admin' => [
                    'en' => "ENG/Main%20Information/Administrative%20structure/Shida%20Kartli/{$enShort}",
                    'ka' => "ძირითადი%20ინფორმაცია/ადმინისტრაციული%20მოწყობა/შიდა%20ქართლი/{$ka}"
                ],
         ...
         * ======================= */
                'pop_urban_rural' => [
                    'en' => "ENG/Population%20census%20pre/urban-rural%20settlements/Shida%20Kartli/{$en}",
                    'ka' => "მოსახლეობის%20აღწერა%20წინასწარი/მოსახლეობა%20საქალაქო-სასოფლო/შიდა%20ქართლი/{$kaSafe}"
                ],
                'pop_by_sex' => [
                    'en' => "ENG/Population%20census%20pre/number%20of%20population%20by%20sex/Shida%20Kartli/{$en}",
                    'ka' => "მოსახლეობის%20აღწერა%20წინასწარი/მოსახლეობა%20სქესის%20მიხედვით/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'employment_employed' => [
                    'en' => "ENG/Employment%20and%20Wages/Employed%20persons/Shida%20Kartli/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/დასაქმებულები/შიდა%20ქართლი/{$kaSafe}"
                ],
                'employment_employees' => [
                    'en' => "ENG/Employment%20and%20Wages/Employees/Shida%20Kartli/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/დაქირავებულები/შიდა%20ქართლი/{$kaSafe}"
                ],
                'employment_salary' => [
                    'en' => "ENG/Employment%20and%20Wages/Average%20monthly%20remuneration/Shida%20Kartli/{$en}",
                    'ka' => "დასაქმება%20და%20ხელფასები/ხელფასი/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'business_investments_fixed' => [
                    'en' => "ENG/Business%20Sector/Investments%20in%20fixed%20assets/Shida%20Kartli/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ინვესტიციები/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                ...
                'birth_stillbirths_by_sex' => [
                    'en' => "ENG/Demography/Number%20of%20stillbirths%20by%20sex/Shida%20Kartli/{$en}",
                    'ka' => "დემოგრაფია/მკვდართშობილები%20სქესის%20მიხედვით/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'business_turnover' => [
                    'en' => "ENG/Business%20Sector/turnover/Shida%20Kartli/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ბრუნვა/შიდა%20ქართლი/{$kaSafe}"
                ],
                'business_production' => [
                    'en' => "ENG/Business%20Sector/Production%20Value/Shida%20Kartli/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/პროდუქციის%20გამოშვება/შიდა%20ქართლი/{$kaSafe}"
                ],
                'business_personnel_costs' => [
                    'en' => "ENG/Business%20Sector/Pesronal%20Costs/Shida%20Kartli/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/შრომითი%20დანახარჯები/შიდა%20ქართლი/{$kaSafe}"
                ],
                'business_purchases' => [
                    'en' => "ENG/Business%20Sector/Purchase%20of%20good%20and%20services/Shida%20Kartli/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/საქონლისა%20და%20მომსახურების%20ყიდვები/შიდა%20ქართლი/{$kaSafe}"
                ],
                'business_purchases_resale' => [
                    'en' => "ENG/Business%20Sector/Purchase%20of%20good%20and%20services%20for%20resale/Shida%20Kartli/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/გადასაყიდად%20განკუთვნილი%20საქონლისა%20და%20მომსახურების%20ყიდვები/შიდა%20ქართლი/{$kaSafe}"
                ],
                'business_value_added' => [
                    'en' => "ENG/Business%20Sector/Value%20added/Shida%20Kartli/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/დამატებული%20ღირებულება/შიდა%20ქართლი/{$kaSafe}"
                ],
                'business_intermediate' => [
                    'en' => "ENG/Business%20Sector/Intermediate%20consumption/Shida%20Kartli/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/შუალედური%20მოხმარება/შიდა%20ქართლი/{$kaSafe}"
                ],
                'business_investment' => [
                    'en' => "ENG/Business%20Sector/Investment%20in%20fixed%20assets/Shida%20Kartli/{$en}",
                    'ka' => "ბიზნეს%20სექტორი/ინვესტიცია%20ძირითად%20კაპიტალში/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'budget_main' => [
                    'en' => "ENG/Budget/Shida%20Kartli/{$en}",
                    'ka' => "ბიუჯეტი/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'construction_permissions' => [
                    'en' => "ENG/Construction/Permissions%20granted/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "მშენებლობა/მშენებლობაზე%20გაცემული%20ნებართვები/შიდა%20ქართლი/{$kaSafe}"
                ],
                'construction_completed' => [
                    'en' => "ENG/Construction/Completed%20Construction/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "მშენებლობა/დასრულებული%20მშენებლობა/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'trading_markets_legal' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20organizational%20legal%20forms%20in%20Georgia/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ორგანიზაციულ-სამართლებლივი%20ფორმების%20მიხედვით/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_ownership' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20ownership%20type%20in%20Georgia/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20საკუთრების%20ფორმის%20მიხედვით/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_type' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20by%20type%20in%20Georgia/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ტიპების%20მიხედვით/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'trading_markets_days' => [
                    'en' => "ENG/Trading/Number%20of%20markets%20and%20fairs%20on%20days%20of%20trade/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20რაოდენობა%20ვაჭრობის%20დღეთა%20მიხედვით/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'trading_employed' => [
                    'en' => "ENG/Trading/Average%20annual%20number%20of%20employed%20persons/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20დირექციებში%20დასაქმებულთა%20რაოდენობა/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'trading_sellers' => [
                    'en' => "ENG/Trading/Number%20of%20market-place%20and%20sellers%20on%20the%20markets%20and%20fairs/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრებში%20და%20ბაზრობებში%20სავაჭრო%20ადგილების%20და%20მოვაჭრეთა%20რაოდენობა/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'trading_financial' => [
                    'en' => "ENG/Trading/Financial%20indices%20of%20markets%20and%20fairs/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20საფინანსო%20მაჩვენებლები/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'transport_roads' => [
                    'en' => "ENG/TransportAndStorage/Length%20of%20transport%20ways/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ტრანსპორტი%20და%20დასაწყობება/საერთო%20სარგებლობის%20საავტომობილო%20გზების%20სიგრძე/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'tourism_domestic' => [
                    'en' => "ENG/Tourism/Shida%20Kartli/{$en}",
                    'ka' => "ტურიზმი/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'healthcare_indicators' => [
                    'en' => "ENG/Healthcare/Indicators/Shida%20Kartli/{$en}",
                    'ka' => "ჯანდაცვა/მაჩვენებლები/შიდა%20ქართლი/{$kaSafe}"
                ],
                'healthcare_emergent' => [
                    'en' => "ENG/Healthcare/Emergent/Shida%20Kartli/{$en}",
                    'ka' => "ჯანდაცვა/სასწრაფო/შიდა%20ქართლი/{$kaSafe}"
                ],
                'healthcare_abortions' => [
                    'en' => "ENG/Healthcare/Abortions/Shida%20Kartli/{$en}",
                    'ka' => "ჯანდაცვა/აბორტები/შიდა%20ქართლი/{$kaSafe}"
                ],
                'healthcare_anemia' => [
                    'en' => "ENG/Healthcare/Anemia/Shida%20Kartli/{$en}",
                    'ka' => "ჯანდაცვა/ანემია/შიდა%20ქართლი/{$kaSafe}"
                ],
                'healthcare_diabetes' => [
                    'en' => "ENG/Healthcare/Diabetes/Shida%20Kartli/{$en}",
                    'ka' => "ჯანდაცვა/დიაბეტი/შიდა%20ქართლი/{$kaSafe}"
                ],
                'healthcare_cancer' => [
                    'en' => "ENG/Healthcare/Cancer/Shida%20Kartli/{$en}",
                    'ka' => "ჯანდაცვა/კიბო/შიდა%20ქართლი/{$kaSafe}"
                ],
                'healthcare_circulatory' => [
                    'en' => "ENG/Healthcare/Circulatory/Shida%20Kartli/{$en}",
                    'ka' => "ჯანდაცვა/სისხლის%20მიმოქცევა/შიდა%20ქართლი/{$kaSafe}"
                ],
                'healthcare_respiratory' => [
                    'en' => "ENG/Healthcare/Respiratory/Shida%20Kartli/{$en}",
                    'ka' => "ჯანდაცვა/სუნთქვა/შიდა%20ქართლი/{$kaSafe}"
                ],
                'healthcare_syphilis' => [
                    'en' => "ENG/Healthcare/Syphilis/Shida%20Kartli/{$en}",
                    'ka' => "ჯანდაცვა/ათაშანგი/შიდა%20ქართლი/{$kaSafe}"
                ],
                'healthcare_aids' => [
                    'en' => "ENG/Healthcare/AIDS/Shida%20Kartli/{$en}",
                    'ka' => "ჯანდაცვა/შიდსი/შიდა%20ქართლი/{$kaSafe}"
                ],
                'healthcare_tuberculosis' => [
                    'en' => "ENG/Healthcare/Tuberculosis/Shida%20Kartli/{$en}",
                    'ka' => "ჯანდაცვა/ტუბერკულიოზი/შიდა%20ქართლი/{$kaSafe}"
                ],
                'healthcare_hepatitis' => [
                    'en' => "ENG/Healthcare/Hepatitis/Shida%20Kartli/{$en}",
                    'ka' => "ჯანდაცვა/ჰეპატიტი/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                ...
                'social_subsistence' => [
                    'en' => "ENG/Social%20Statistic/Subsistence%20Allowance/Shida%20Kartli/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/საარსებო/შიდა%20ქართლი/{$kaSafe}"
                ],
                'social_receiving' => [
                    'en' => "ENG/Social%20Statistic/Receiving/Shida%20Kartli/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/მიმღები/შიდა%20ქართლი/{$kaSafe}"
                ],
                'social_beneficiaries' => [
                    'en' => "ENG/Social%20Statistic/Beneficiaries/Shida%20Kartli/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/ბენეფიციართა/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'education_preschool' => [
                    'en' => "ENG/Education/Preschool%20and%20Education%20Institutions/Shida%20Kartli/{$en}",
                    'ka' => "განათლება/სკოლამდელი%20აღზრდისა%20და%20განათლების%20დაწესებულებები/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'education_general' => [
                    'en' => "ENG/Education/General%20Educational%20Institution/Shida%20Kartli/{$en}",
                    'ka' => "განათლება/ზოგადსაგანმანათლებლო%20დაწესებულებები/შიდა%20ქართლი/{$kaSafe}"
                ],
                'education_status' => [
                    'en' => "ENG/Education/Status/Shida%20Kartli/{$municipal_info['en_full']}",
                    'ka' => "განათლება/სტატუსი/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'education_directors' => [
                    'en' => "ENG/Education/Directors/Shida%20Kartli/{$municipal_info['en_full']}",
                    'ka' => "განათლება/დირექტორები/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'education_vocational' => [
                    'en' => "ENG/Education/Vocational%20and%20Higher%20educational%20institutions/Adjara/{$en}",
                    'ka' => "განათლება/პროფესიული%20და%20უმაღლესი%20საგანმანათლებლო%20დაწესებულებები/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'culture' => [
                    'en' => "ENG/Culture/Shida%20Kartli/{$en}",
                    'ka' => "კულტურა/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                ...
                'trading_financial_indices' => [
                    'en' => "ENG/Trading/Financial%20indices%20of%20markets%20and%20fairs/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ვაჭრობა/ბაზრების%20და%20ბაზრობების%20საფინანსო%20მაჩვენებლები/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'business_register_entities' => [
                    'en' => "ENG/Business%20Register/Registered%20entities%20per%201000%20persons/Shida%20Kartli/{$en}",
                    'ka' => "ბიზნეს%20რეგისტრი/რეგისტრირებული%20სუბიექტები/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'business_register_newly' => [
                    'en' => "ENG/Business%20Register/Number%20of%20newly%20registered%20business%20entities%20in%20Georgia/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/ახლად%20რეგისტრირებული%20ბიზნეს%20სუბიექტები/შიდა%20ქართლი/{$kaSafe}"
                ],
                'business_register_active' => [
                    'en' => "ENG/Business%20Register/Number%20of%20active%20business%20entities%20registered%20in%20Georgia/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/ეკონომიკურად%20აქტიური%20ბიზნეს%20სუბიექტების%20რაოდენობა/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'business_register_public' => [
                    'en' => "ENG/Business%20Register/Number%20of%20public%20institutions/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ბიზნეს%20რეგისტრი/საჯარო%20დაწესებულებების%20რაოდენობა/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'economic_activity_registered' => [
                    'en' => "ENG/byKindOfEconomicActivity/Number%20of%20registered%20entities%20by%20kind%20of%20economic%20activity/Shida%20Kartli/{$en}",
                    'ka' => "ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/შიდა%20ქართლი/{$kaSafe}"
                ],
                'economic_activity_active' => [
                    'en' => "ENG/byKindOfEconomicActivity/Number%20of%20active%20entities%20by%20kind%20of%20economic%20activity/Shida%20Kartli/{$en}",
                    'ka' => "ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20ეკონომიკური%20საქმიანობის%20სახეების%20მიხედვით/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'ownership_registered' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20registered%20entities%20by%20ownership%20type/Shida%20Kartli/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20საკუთრების%20ფორმების%20მიხედვით/შიდა%20ქართლი/{$kaSafe}"
                ],
                'ownership_active_size' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20active%20entities%20by%20ownership%20type%20and%20size/Shida%20Kartli/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20საკუთრების%20ფორმებისა%20და%20ზომების%20მიხედვით/შიდა%20ქართლი/{$kaSafe}"
                ],
                'ownership_newly' => [
                    'en' => "ENG/byOwnershipType/Number%20of%20entities%20newly%20registered%20in%20Georgia%20by%20ownership%20type/Shida%20Kartli/{$en}",
                    'ka' => "საკუთრების%20ფორმების%20მიხედვით/ახლადრეგისტრირებულ%20სუბიექტთა%20რაოდენობა/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'organizational_registered' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20registered%20entities%20by%20organizational-legal%20form/Shida%20Kartli/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/რეგისტრირებულ%20სუბიექტთა%20რაოდენობა%20ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/შიდა%20ქართლი/{$kaSafe}"
                ],
                'organizational_active' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20active%20entities%20by%20organizational-legal%20form/Shida%20Kartli/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/რეგისტრირებულ%20მოქმედ%20სუბიექტთა%20რაოდენობა%20ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვ/შიდა%20ქართლი/{$kaSafe}"
                ],
                'organizational_newly' => [
                    'en' => "ENG/byOrganization-legalForms/Number%20of%20entities%20newly%20registered%20in%20Georgia%20by%20organizational-legal%20form/Shida%20Kartli/{$en}",
                    'ka' => "ორგანიზაციულ-სამართლებრივი%20ფორმების%20მიხედვით/ახლადრეგისტრირებულ%20სუბიექტთა%20რაოდენობა/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'agriculture_land' => [
                    'en' => "ENG/Share%20of%20Agriculture%20Land%20Area/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "soflis%20meurneoba/ეკო_აქტ/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'hotels_accommodation' => [
                    'en' => "ENG/Hotels/Accommodation/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/სასტუმრო%20ობიექტები/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'hotels_visitors_residents' => [
                    'en' => "ENG/Hotels/Visitors%20Residents/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ვიზიტორები%20რეზიდენტები/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'hotels_visitors_nonresidents' => [
                    'en' => "ENG/Hotels/Visitors%20non%20residents/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ვიზიტორები%20არარეზიდენტები/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'hotels_nights_residents' => [
                    'en' => "ENG/Hotels/Nights%20spent%20Residents/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმრო%20ობიექტები/ღამეები%20რეზიდენტები/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'hotels_number_area' => [
                    'en' => "ENG/Hotels/Number%20of%20hotels%20and%20hotel-type%20establishments%20and%20their%20total%20area/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სასტუმროების%20რაოდენობა%20და%20ფართობი/შიდა%20ქართლი/{$kaSafe}"
                ],
                'hotels_rooms' => [
                    'en' => "ENG/Hotels/Number%20of%20Rooms%20in%20Hotels%20and%20Hotel-type%20enterprises/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმროები/ნომრების%20რაოდენობა%20სასტუმროებსა%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში/შიდა%20ქართლი/{$kaSafe}"
                ],
                'hotels_guests' => [
                    'en' => "ENG/Hotels/Guests/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სტუმრები/შიდა%20ქართლი/{$kaSafe}"
                ],
                'hotels_employees' => [
                    'en' => "ENG/Hotels/Number%20of%20Employees%20in%20Hotels%20and%20Hotel-type%20enterprises/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "სასტუმროები/სასტუმროების%20და%20სასტუმროს%20ტიპის%20დაწესებულებებში%20დასაქმებულთა%20რაოდენობა%20სქესის%20მიხედვით/შიდა%20ქართლი/{$kaSafe}"
                ],
         ...
         * ======================= */
                'social_indicators' => [
                    'en' => "ENG/Social%20Statistic/Indicators/Shida%20Kartli/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/მაჭვენებლები/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'social_disability' => [
                    'en' => "ENG/Social%20Statistic/Disability%20Persons/Shida%20Kartli/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/დევნილი%20შშმ%20პირები/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'social_registered' => [
                    'en' => "ENG/Social%20Statistic/Disabilities%20Registered/Shida%20Kartli/{$en}",
                    'ka' => "სოციალური%20სტატისტიკა/რეგისტრირებული%20შშმ%20პირები/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
         ...
         * ======================= */
                'self_governance' => [
                    'en' => "ENG/Government/Self-Governance/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ხელისუფლება/თვითმმართველობა/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
                'voters' => [
                    'en' => "ENG/Government/Voters/Shida%20Kartli/{$en}%20Municipality",
                    'ka' => "ხელისუფლება/ამომრჩეველი/შიდა%20ქართლი/{$municipal_info['ka_full']}"
                ],
            ];
